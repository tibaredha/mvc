...
?>
<h2>Receveur : <?php echo $this->user[0]['NOM'].'_'.$this->user[0]['PRENOM'];    ?></h2>
<hr /><br />
<div class="tabbed_area">  
		...
		<label>Gender</label><input type="text" name="SEX"  value="<?php echo $this->user[0]['SEX']; ?>"  /><br />
	    <label>Gender</label><input type="text" name="DATENAISSANCE"  value="<?php echo $this->user[0]['DATENAISSANCE']; ?>"  /><br />
		...
		<label>Wilaya de naissance </label><input type="text" name="WILAYA"          value="<?php echo nbrtostring('wil','IDWIL', $this->user[0]['WILAYA'],'WILAYAS');    ?>"  /><br />
		<label>Wilaya de residence </label><input type="text" name="WILAYAR"        value="<?php echo nbrtostring('wil','IDWIL', $this->user[0]['WILAYAR'],'WILAYAS');   ?>"  /><br />
		<label>Commune de naissance </label><input type="text" name="COMMUNE"        value="<?php echo nbrtostring('com','IDCOM', $this->user[0]['COMMUNE'],'COMMUNE');   ?>"  /><br />
		<label>Commune de residence </label><input type="text" name="COMMUNER"      value="<?php echo nbrtostring('com','IDCOM', $this->user[0]['COMMUNER'],'COMMUNE');   ?>"  /><br />
		<label>Adresse de residence </label><input type="text" name="ADRESSE"        value="<?php echo $this->user[0]['ADRESSE'];    ?>"  /><br />
