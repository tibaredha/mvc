<?php 
verifsession();
view::button('dis',$this->user[0]['id']);
...
View::h('2',25,290,'Receveur : Bilan Biologique [ '.$this->user[0]['NOM']."_".$this->user[0]['PRENOM']." ]");
View::sautligne(2);
View::hr();
View::f0(URL.'rec/BILANOK/','post');
...
<div class="tabbed_area">  
		...
		{		
				foreach($this->userListview as $key => $value){ ?>
						...
						<td align="center" class="bg-gray" style="padding: 5px 5px;"><a title="Qualification" href="<?php echo URL.'pdf/RESBILANPDF1.php?id='.$value['idbio'].'&IDDNR='.$this->user[0]['id'];?>"><img src='<?php echo URL.'public/images/icons/lab1.jpg';?>' width='30' height='30' border='0' alt=''/></a></td>       
						<td align="center"><a title="editer" href="<?php echo URL.'rec/editbilan/'.$value['idbio'];?>"><img src='<?php echo URL.'public/images/icons/edit.PNG';?>' width='16' height='16' border='0' alt=''/></a></td>
						<td align="center"><a class="delete" title="supprimer" href="<?php echo URL.'rec/deletebilan/'.$value['idbio'].'/'.$value['ID'];?>"><img src='<?php echo URL.'public/images/icons/delete.PNG';?>' width='16' height='16' border='0' alt=''/></a></td>
						</tr>
				<?php 
				}
				...
				if ($total_count <= 0 )
				{
				echo '<tr><td align="center" colspan="21" ><span> No record found for recveur </span></td> </tr>';
		...
		{
		echo '<tr><td align="center" colspan="21" ><span> Click search button to start searching a recveur.</span></td></tr>';
