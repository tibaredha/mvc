...
View::sautligne(2);
View::hr();
View::f0(URL.'rec/ajouterArticle/','post');
...
View::f1();	
View::sautligne(15+rec::compterArticles());
$x=450;
$y=360;
	...
	if ( rec::creationPanier()  )
	{
	   ...
	   else
	   {
	      for ($i=0 ;$i < $nbArticles ; $i++)
	      {
			 ...
			 echo "<td align=\"center\"><a href=\"".URL."rec/supprimerArticle/".$_SESSION['ordonnace']['libelleProduit'][$i]."/".$this->user[0]['id']."\"><img src=\"".URL."public/images/icons/delete.PNG\"     width=\'20\' height=\'20\' border=\'0\'alt=\'\' /></a></td>";  
			 echo "</tr>";
	      }
	      echo '<tr bgcolor="#98F5FF" ><td colspan="7">'; 
		  echo "Nombre total de medicament : ".rec::compterArticles();
		  echo "</td>";	     
		  echo "</tr>";
		  echo '<tr bgcolor="#98F5FF"     ><td colspan="3">Montant total'; 
		  $ttc=rec::MontantGlobal()*1;
		  echo "</td>";
	      echo "<td colspan=\"4\">";
		...
		echo '<tr  bgcolor="#F0F8FF" >';//
			  ...
			  echo '&nbsp;'; echo '<a href="'.URL.'rec/supprimePanier/'.$this->user[0]['id'].'"><img src="'.URL.'public/images/icons/delete.PNG'.'" width=\'20\' height=\'20\' border=\'0\' alt=\'\'/>Suprimer</a>';echo '&nbsp;'; 
			  echo "</td>";
			  echo "<td  align=\"center\" colspan=\"4\">";
			  echo '<a href="'.URL.'pdf/phaf2.php?uc='.$this->user[0]['id'].'"><img src="'.URL.'public/images/icons/print.PNG'.'" width=\'20\' height=\'20\' border=\'0\' alt=\'\'/>Imprimer</a>';echo '&nbsp;'; 
			  echo "</td>";
		echo "</tr>";	  
	   }
	}
