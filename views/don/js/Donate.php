...
<div class="tabbed_area">  
		...
		{  
		echo'<tr bgcolor="yellow"> <td>'.$ques.'</td>';
		echo'<td colspan="2"><input type="txt" name="IDP" value="'.idp().'"/>';
		echo'</td>';
		echo'</tr>';
		}
		function DATEDON ($ques) 
		{  
		echo'<tr bgcolor="yellow"> <td>'.$ques.'</td>';
		echo'<td colspan="2"><input type="txt" name="DATEDON" value="'.date ('Y-m-d').'"/>';
		echo'</td>';
		echo'</tr>';
		}
		
		function HEUREDON ($ques) 
		{  
		echo'<tr bgcolor="yellow"> <td>'.$ques.'</td>';
		echo'<td colspan="2"><input type="txt" name="HEUREDON" value="'.date ("H:i").'"/>';
		echo'</td>';
		echo'</tr>';
		}
		
		DATEDON ('Date of Donation');
		HEUREDON ('heure of Donation');
		ind ('Indication');
		npoche ('ID Poche automatique ');
