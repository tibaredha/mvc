...
<div class="tabbed_area">  
		...
		<th style="width:50px;">NAPP</th>
		<th style="width:80px;">Date seance</th>
		<th style="width:80px;">Heure seance</th>
		<th style="width:50px;">Type  seance</th>
		<th style="width:50px;">Acc   Sang</th>
		<th style="width:50px;">POIDSD</th>
		<th style="width:50px;">TAD</th>
		<th style="width:50px;">POIDSF</th>
		<th style="width:50px;">TAF</th>
		...
		{		
				foreach($this->userListview as $key => $value){ ?>
						...
						<td align="center"><?php echo $value['POIDSD'];?></td>
					    <td align="center"><?php echo $value['SYSD'].'_'.$value['DIAD'];?></td>
					    <td align="center"><?php echo $value['POIDSF'];?></td>
						<td align="center"><?php echo $value['SYSF'].'_'.$value['DIAF'];?></td>
