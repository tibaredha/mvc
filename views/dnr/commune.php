...
{	
        ...
        ?>
			...
			<td align="left" >  <?php echo $value['COMMUNE'];    ?></td>
			<td align="center" > <STRONG> <?php $WILAYAR='17000'; echo  view::dnrparcommune($WILAYAR,$value['IDCOM']) ; ?></STRONG></td>
		...
		echo '<tr bgcolor="#00CED1"  ><td align="left"   colspan="9" ><span>' .$total_count.' commune(s) found.</span></td></tr>';			
}				
echo "</table>";
?>