...
{	
        ...
        ?>
			...
			<td align="center" > <STRONG> <?php echo view::dnrparwilaya($value['IDWIL']);?></STRONG></td>
		...
		echo '<tr bgcolor="#00CED1"  ><td align="left"   colspan="9" ><span>' .$total_count.' wilaya(s) found.</span></td></tr>';			
}				
echo "</table>";
?>