...
View::sautligne(2);
View::hr();
View::f0(URL.'pha/editSave/'.$this->user[0]['id'],'post');
View::label(25,370,'categorie');View::combov(215,370,'categorie',array($this->user[0]['categorie'],"A","B","C","b"));
View::label(25,400,'Nom Produit');View::txt(215,400,'NOM',0,$this->user[0]['mecicament']);
View::label(25,430,'decription Produit');View::txt(215,430,'PRENOM',0,$this->user[0]['pre']);
...
View::photosurl(1100,350,URL.'public/images/pha/'.$this->user[0]['id'].'.jpg');	
