...
view::munu('maldecobl'); 
$colspan=14;
$c='maldecobl';      //controlleur
$m='search';         //methode
$dphotos='maldecobl';//dossier photos				
...
echo "</tr>" ;	
		foreach($this->userListview as $key => $value)
		{
			...
			echo'<td align="center" >'.trim($this->dateUS2FR($value['DATEMDO'])).'</td>';
			...
			echo'<td align="left" >'.trim(view::nbrtostring('mdo','id',$value['MDO'],'mdo')).'</td>';
			echo'<td align="left" >'.trim($value['OBSERVATION']).'</td>';
			...
			echo '<td align="center"><a title="fd '.trim($value['id']).', '.trim($value['id']).'  "   href="'.URL.'pdf/mdo/fmdo.php?id='.$value['id'].'&mdo='.$value['MDO'].'"><img src="'.URL.'public/images/icons/print.PNG" width="16" height="16" border="0" alt=""/></a></td>';
		echo '</tr>';
		}
