...
$this->label($x+960,$y+190+30,'تاريخ النفاذ');        $this->txts($x+700,$y+180+30,'DATEDEFFET',0,$data['DATEDEFFET'],'dateus2');
$this->label($x+610,$y+190+30,'رقم المقرر');          $this->txtarid($x+350,$y+180+30,'NDECISION','NDECISION',0,$data['NDECISION'],'date');                    
$this->label($x+260,$y+190+30,'تاريخ المقرر');        $this->txts($x,$y+180+30,'DATEDECISION',0,$data['DATEDECISION'],'dateus3');
...
<table  width='100%' border='1' cellpadding='5' cellspacing='1' align='center'>
	<tr>
		<th  colspan=10 style="width:50px;"><?php echo '<a title="Autres"  href="'.URL.'drh/search/0/10?o=idp&q='.$this->user[0]['idp'].'" > GRH : </a>';?></th> 
