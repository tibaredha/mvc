...
{	
	...
	if($x>10   and $x<=20){$valeur= "#cc6674";}
	if($x>20   and $x<=40){$valeur= "#992038";}
	if($x>40   and $x<=500){$valeur= "#60000e";}
	return $valeur;
}
function color1($x) //nuance du vert http://www.jokconcept.net/generateur-nuancier-degrade-couleurs.php
{	
	if($x<=0)                  {$valeur= "#00BB00";}//#00FF00
	if($x>=1   and $x<=10)     {$valeur= "#009900";}//#00DD00
	if($x>10   and $x<=20)     {$valeur= "#007700";}
	if($x>20   and $x<=40)     {$valeur= "#005500";}
	if($x>40   and $x<=100)    {$valeur= "#003300";}    
	return $valeur;
}
...
{
header("Location: ../inspection/ALGERIE") ;
}

function valeurmoisdeces1($DATEJOUR1,$DATEJOUR2,$COMMUNER,$STRUCTURED) 
{
mysqlconnect();
$sql = " select * from structure  where   COMMUNE='$COMMUNER' and STRUCTURE $STRUCTURED   ";
...
$data = array(
"916"  => color(valeurmoisdeces1($datejour1,$datejour2,916,$EPH)),//Djelfa
"917"  => color(valeurmoisdeces1($datejour1,$datejour2,917,$EPH)),//El Idrissia
"918"  => color(valeurmoisdeces1($datejour1,$datejour2,918,$EPH)),//Oum Cheggag
"919"  => color(valeurmoisdeces1($datejour1,$datejour2,919,$EPH)),//El Guedid
"920"  => color(valeurmoisdeces1($datejour1,$datejour2,920,$EPH)),//Charef
"921"  => color(valeurmoisdeces1($datejour1,$datejour2,921,$EPH)),//El Hammam
"922"  => color(valeurmoisdeces1($datejour1,$datejour2,922,$EPH)),//Touazi
"923"  => color(valeurmoisdeces1($datejour1,$datejour2,923,$EPH)),//Beni Yacoub
"924"  => color(valeurmoisdeces1($datejour1,$datejour2,924,$EPH)),//ainoussera
"925"  => color(valeurmoisdeces1($datejour1,$datejour2,925,$EPH)),//guernini
"926"  => color(valeurmoisdeces1($datejour1,$datejour2,926,$EPH)),//sidilaadjel
"927"  => color(valeurmoisdeces1($datejour1,$datejour2,927,$EPH)),//hassifdoul
"928"  => color(valeurmoisdeces1($datejour1,$datejour2,928,$EPH)),//elkhamis
"929"  => color(valeurmoisdeces1($datejour1,$datejour2,929,$EPH)),//birine
"930"  => color(valeurmoisdeces1($datejour1,$datejour2,930,$EPH)),//Dra Souary
"931"  => color(valeurmoisdeces1($datejour1,$datejour2,931,$EPH)),//benahar
"932"  => color(valeurmoisdeces1($datejour1,$datejour2,932,$EPH)),//hadshari
"933"  => color(valeurmoisdeces1($datejour1,$datejour2,933,$EPH)),//bouiratlahdab
"934"  => color(valeurmoisdeces1($datejour1,$datejour2,934,$EPH)),//ainfka
"935"  => color(valeurmoisdeces1($datejour1,$datejour2,935,$EPH)),//hassi bahbah
"936"  => color(valeurmoisdeces1($datejour1,$datejour2,936,$EPH)),//Mouilah
"937"  => color(valeurmoisdeces1($datejour1,$datejour2,937,$EPH)),//El Mesrane
"938"  => color(valeurmoisdeces1($datejour1,$datejour2,938,$EPH)),//Hassi el Mora
"939"  => color(valeurmoisdeces1($datejour1,$datejour2,939,$EPH)),//zaafrane
"940"  => color(valeurmoisdeces1($datejour1,$datejour2,940,$EPH)),//hassi el euche
"941"  => color(valeurmoisdeces1($datejour1,$datejour2,941,$EPH)),//ain maabed  
"942"  => color(valeurmoisdeces1($datejour1,$datejour2,942,$EPH)),//darchioukh
"943"  => color(valeurmoisdeces1($datejour1,$datejour2,943,$EPH)),//Guendouza
"944"  => color(valeurmoisdeces1($datejour1,$datejour2,944,$EPH)),//El Oguila
"945"  => color(valeurmoisdeces1($datejour1,$datejour2,945,$EPH)),//El Merdja
"946"  => color(valeurmoisdeces1($datejour1,$datejour2,946,$EPH)),//mliliha
"947"  => color(valeurmoisdeces1($datejour1,$datejour2,947,$EPH)),//sidibayzid
"948"  => color(valeurmoisdeces1($datejour1,$datejour2,948,$EPH)),//Messad
"949"  => color(valeurmoisdeces1($datejour1,$datejour2,949,$EPH)),//Abdelmadjid
"950"  => color(valeurmoisdeces1($datejour1,$datejour2,950,$EPH)),//Haniet Ouled Salem
"951"  => color(valeurmoisdeces1($datejour1,$datejour2,951,$EPH)),//Guettara
"952"  => color(valeurmoisdeces1($datejour1,$datejour2,952,$EPH)),//Deldoul
"953"  => color(valeurmoisdeces1($datejour1,$datejour2,953,$EPH)),//Sed Rahal
"954"  => color(valeurmoisdeces1($datejour1,$datejour2,954,$EPH)),//Selmana
"955"  => color(valeurmoisdeces1($datejour1,$datejour2,955,$EPH)),//El Gahra
"956"  => color(valeurmoisdeces1($datejour1,$datejour2,956,$EPH)),//Oum Laadham
"957"  => color(valeurmoisdeces1($datejour1,$datejour2,957,$EPH)),//Mouadjebar
"958"  => color(valeurmoisdeces1($datejour1,$datejour2,958,$EPH)),//Ain el Ibel
"959"  => color(valeurmoisdeces1($datejour1,$datejour2,959,$EPH)),//Amera
"960"  => color(valeurmoisdeces1($datejour1,$datejour2,960,$EPH)),//N'thila
"961"  => color(valeurmoisdeces1($datejour1,$datejour2,961,$EPH)),//Oued Seddeur
"962"  => color(valeurmoisdeces1($datejour1,$datejour2,962,$EPH)),//Zaccar
"963"  => color(valeurmoisdeces1($datejour1,$datejour2,963,$EPH)),//Douis
"964"  => color(valeurmoisdeces1($datejour1,$datejour2,964,$EPH)),//Ain Chouhada
"965"  => color(valeurmoisdeces1($datejour1,$datejour2,965,$EPH)),//Tadmit
"966"  => color(valeurmoisdeces1($datejour1,$datejour2,966,$EPH)),//El Hiouhi
"967"  => color(valeurmoisdeces1($datejour1,$datejour2,967,$EPH)),//Faidh el Botma
"968"  => color(valeurmoisdeces1($datejour1,$datejour2,968,$EPH)) //Amourah
);
...
<text class="label" id="country_name1" x="280" y="45">Repartition Des Structures </text>  	  
<text class="label" id="country_name1" x="285" y="60">Par Commune de residence</text>  	  
<text class="label" id="country_name1" x="285" y="75"><?php echo $EPH1 ;?></text>  	  
<text class="label" id="country_name1" x="285" y="90"><?php echo "Du ".dateUS2FR($datejour1)." Au ".dateUS2FR($datejour2);?></text>  	  
...
<rect x="10" y="500" width="20" height="20" class="key colour2" /><text x="35" y="515">11 to 20</text>
<rect x="10" y="525" width="20" height="20" class="key colour3" /><text x="35" y="540">21 to 40</text>
<rect x="10" y="550" width="20" height="20" class="key colour4" /><text x="35" y="565">41+</text>
</g>
<rect
x="270" y="95"
width="110" 
