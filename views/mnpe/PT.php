...
ob_start();
$data = array(
"titre"     => 'Nouveau Poids / Taille / Sexe', 
"btn"       => 'mnpe', 
"id"        => '', 
"butun"     => 'Inserer Poids', 
"photos"    => '3.jpg',
"action"    => 'mnpe/creatept/',
"AGE"       => '',
"SEXE"      => array("F", "M"),
"M3ET"      => '00',
"M2ET"      => '00',
...
<?php
echo '<a href="'.URL.'pdf/imppa.php">Imprimer table Poids / taille / Masculin </a>'; echo '&nbsp;';	
?>
</th>
</tr>
<tr>
...
<th style="width:10px;"  colspan="9"    >
<?php
echo '<a href="'.URL.'pdf/impdpd.php">Imprimer table Poids / taille / Feminin </a>'; echo '&nbsp;';	
?>
</th>
</tr>
<tr>
...
echo "</table>";
view::graphemnpe(400,240,'table Poids / taille / Masculin','pt','F');
?>
