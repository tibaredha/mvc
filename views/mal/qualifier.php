...
verifsession();	
view::button('qua','');
View::h('2',25,290,'Qualification : malade : '.$this->user[0]['NOM'].'_'.$this->user[0]['NOM']);
View::sautligne(2);
View::hr();
View::f0(URL.'mal/editSave/'.$this->user[0]['id'],'post');
View::label(25,400,'Qualification date');View::txt(215,400,'DATEQUA',0,date('Y-m-d'));
View::label(25,430,'ABO');View::combov(215,430,'GRABO',array($this->user[0]['GRABO'],"A","B","AB","O"));   View::label(500,430,'C'); View::combov(550,430,'GRRH2',array($this->user[0]['CRH2'],"Positif","negatif"));  
View::label(25,460,'RH'); View::combov(215,460,'GRRH1',array($this->user[0]['GRRH'],"Positif","negatif"));  View::label(500,460,'c'); View::combov(550,460,'GRRH4',array($this->user[0]['CRH4'],"Positif","negatif"));
