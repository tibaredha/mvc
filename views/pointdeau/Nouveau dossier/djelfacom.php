...
$data = array(
"916"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,916,'')),//Djelfa
"917"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,917,'')),//El Idrissia
"918"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,918,'')),//Oum Cheggag
"919"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,919,'')),//El Guedid
"920"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,920,'')),//Charef
"921"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,921,'')),//El Hammam
"922"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,922,'')),//Touazi
"923"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,923,'')),//Beni Yacoub
"924"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,924,'')),//ainoussera
"925"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,925,'')),//guernini
"926"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,926,'')),//sidilaadjel
"927"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,927,'')),//hassifdoul
"928"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,928,'')),//elkhamis
"929"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,929,'')),//birine
"930"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,930,'')),//Dra Souary
"931"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,931,'')),//benahar
"932"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,932,'')),//hadshari
"933"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,933,'')),//bouiratlahdab
"934"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,934,'')),//ainfka
"935"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,935,'')),//hassi bahbah
"936"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,936,'')),//Mouilah
"937"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,937,'')),//El Mesrane
"938"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,938,'')),//Hassi el Mora
"939"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,939,'')),//zaafrane
"940"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,940,'')),//hassi el euche
"941"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,941,'')),//ain maabed  
"942"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,942,'')),//darchioukh
"943"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,943,'')),//Guendouza
"944"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,944,'')),//El Oguila
"945"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,945,'')),//El Merdja
"946"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,946,'')),//mliliha
"947"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,947,'')),//sidibayzid
"948"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,948,'')),//Messad
"949"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,949,'')),//Abdelmadjid
"950"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,950,'')),//Haniet Ouled Salem
"951"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,951,'')),//Guettara
"952"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,952,'')),//Deldoul
"953"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,953,'')),//Sed Rahal
"954"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,954,'')),//Selmana
"955"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,955,'')),//El Gahra
"956"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,956,'')),//Oum Laadham
"957"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,957,'')),//Mouadjebar
"958"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,958,'')),//Ain el Ibel
"959"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,959,'')),//Amera
"960"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,960,'')),//N'thila
"961"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,961,'')),//Oued Seddeur
"962"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,962,'')),//Zaccar
"963"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,963,'')),//Douis
"964"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,964,'')),//Ain Chouhada
"965"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,965,'')),//Tadmit
"966"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,966,'')),//El Hiouhi
"967"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,967,'')),//Faidh el Botma
"968"  => color(view::valeurmoisdeces('','deceshosp','DINS','COMMUNER',$datejour1,$datejour2,968,'')) //Amourah
);
...
<![CDATA[
    ...
    var data1 = [['ghana', 'togo'],
                 ['burkina-faso', 'cameroon', 'chad', 'eq-guinea'],
                 ['car', 'congo', 'cote-ivoire'],
                 ['angola', 'drc', 'uganda']];
	...
	function notify(){location.href="http://localhost/mvc/dnr/"}
...
<text class="label" id="country_name1" x="270" y="45">Repartition Des deces hospitalier </text>  	  
<text class="label" id="country_name1" x="285" y="60">Par Commune de residence</text>  	  
<text class="label" id="country_name1" x="285" y="75"><?php echo "Du ".dateUS2FR($datejour1)." Au ".dateUS2FR($datejour2);?></text>  	  
