...
"STRUCTURED"  => array("EPH_DJALFA", "EPH_AIN_OUSSERA", "EPH_HASSI_BAHBAH", "EPH_MESSAAD", "EHS_DJELFA"),
"NOM"       => 'x',
"PRENOM"    => 'x',   
"FILSDE"    => 'x',
"ETDE"      => 'x',
...
//codage cim
View::label($data['x'],$data['y']+440,'CIM 10 Chapitre/categorie');View::cim1($data['x']+190,$data['y']+430,'CODECIM0','mvc','chapitre',$data['CODECIM0a'],$data['CODECIM0b']);
