...
view::button('qua','');
?>
<h2>Donor : Serologie Positve Pour HIV </h2 >
<hr /><br />
...
<tr>
<th style="width:50px;">FICHE IPA HIV</th> 
...
{	
        ...
        ?>
			...
			<td align="center" class="bg-gray" style="padding: 5px 5px;"><button onclick="document.location='<?php echo URL.'PDF/FHIV.php?uc='.$value['id']; ?>'" title="FICHE IPA HIV <?php echo $value['IDP'].', '.$value['IDP']?>'s Record" <?php //echo ($allow_donate==FALSE)?'disabled':'';?> >&nbsp;&nbsp;<img src="<?php echo URL.'public/images/icons/main_blood_drop.jpg';?>" width='16' height='16' border='0' alt=''/>&nbsp;&nbsp;</button></td>
