...
view::button('qua','');
?>
<h2>Donor : Serologie Positve Pour SYS </h2 >
<hr /><br />
<table  width='90%' border='1' cellpadding='5' cellspacing='1' align='center'>
<tr  >
<th colspan="7" style="width:80px;">
<button onclick="document.location='<?php echo URL.'don/HVB/'; ?>'" title="HVB">HVB [+]</button>
<button onclick="document.location='<?php echo URL.'don/HVC/'; ?>'" title="HVC">HVC [+]</button>
<button onclick="document.location='<?php echo URL.'don/HIV/'; ?>'" title="HIV">HIV [+]</button>
<button onclick="document.location='<?php echo URL.'don/SYS/'; ?>'" title="TPHA">TPHA [+]</button>
</th> 
</tr>
<tr>
<th style="width:50px;">FICHE IPA SYS</th> 
...
{	
        ...
        ?>
			...
			<td align="center" class="bg-gray" style="padding: 5px 5px;"><button onclick="document.location='<?php echo URL.'PDF/FSYS.php?uc='.$value['id']; ?>'" title="FICHE IPA SYS <?php echo $value['IDP'].', '.$value['IDP']?>'s Record" <?php //echo ($allow_donate==FALSE)?'disabled':'';?> >&nbsp;&nbsp;<img src="<?php echo URL.'public/images/icons/main_blood_drop.jpg';?>" width='16' height='16' border='0' alt=''/>&nbsp;&nbsp;</button></td>
