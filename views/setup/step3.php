...
<div class="span-5 colborder">
	        ...
	        <ol>
				...
				<li <?php //if ($step == "filePermissions") echo "class='current'"; ?>><b>File permissions</b></li>
...
<table  width='65%' >
	...
	<tbody>
		...
		<tr bgcolor="white">
			...
			<td><?php if ($permissions['error'] == "") { ?><img src="<?php echo URL;?>public/images/icons/accept.png"> OK <?php } else { ?><img src="<?php echo URL;?>public/images/icons/cancel.png"><?php echo $permissions['error']; ?> <?php } ?></td>
		</tr>
		<?php endforeach; ?>
	</tbody>
</table>
