...
<form method="post" action="<?php echo URL;?>dnr/create/; ?>"> 
	...
	<label>ADRESSE DE RESIDENCE </label> <?php WILAYA(260,540,'WILAYAR','countryr','gpts2012','wil');?>&nbsp;<?php COMMUNE(670,540,'COMMUNER','COMMUNER');?><input type="text" name="ADRESSE" value="" required /><br />
