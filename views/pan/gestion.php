...
{	
        ...
        ?>
			...
			<td align="center"><a title="editer <?php echo trim($value['id']);?>'s Record"                        href="<?php echo URL.'pan/edit/'.$value['id'].'/'.$value['categorie'];?>">      <img src="<?php echo URL.'public/images/icons/edit.PNG';?>"   width='16' height='16' border='0' alt=''/></a></td>
			<td align="center"><a title="supprimer <?php echo trim($value['id']);?>'s Record"  class="delete"     href="<?php echo URL.'pan/delete/'.$value['id'];?>">    <img src="<?php echo URL.'public/images/icons/delete.PNG';?>" width='16' height='16' border='0' alt=''/></a></td>
