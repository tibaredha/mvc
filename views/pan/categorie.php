...
echo "</br>";
echo "Total HT: ".Pan::MontantGlobal()." DA ";
...
{	
        ...
        ?>
			...
			<td align="center" >  <?php echo $value['price'].'DA';    ?></td>
			<td align="center" > 
			...
			{
			?>
			<img src="<?php echo URL.'public/images/icons/ok.jpg';?>"   width='26' height='26' border='0' alt=''/>
			<?php
			echo 'Disponible'; 
			}
			else
			{
			?>
			<img src="<?php echo URL.'public/images/icons/non.jpg';?>"   width='26' height='26' border='0' alt=''/>
			<?php
			echo 'Indisponible';
			}   
			?>
			</td>
			<td align="center"><a title="Ajouter au panier <?php echo trim($value['name']);?>'s Record" href="<?php echo URL.'pan/ajouterArticle/'.$value['name'].'/'.$value['price'].'/'.$value['categorie'].'/'.$value['qte'];?>"> <img src="<?php echo URL.'public/images/icons/pan.png';?>"   width='26' height='26' border='0' alt=''/></a></td>
			</tr>
        <?php 
		}
