...
$data = array(
"916"  => color(view::dnrparcommune('17000',916)),//Djelfa
"917"  => color(view::dnrparcommune('17000',917)),//El Idrissia
"918"  => color(view::dnrparcommune('17000',918)),//Oum Cheggag
"919"  => color(view::dnrparcommune('17000',919)),//El Guedid
"920"  => color(view::dnrparcommune('17000',920)),//Charef
"921"  => color(view::dnrparcommune('17000',921)),//El Hammam
"922"  => color(view::dnrparcommune('17000',922)),//Touazi
"923"  => color(view::dnrparcommune('17000',923)),//Beni Yacoub
"924"  => color(view::dnrparcommune('17000',924)),//ainoussera
"925"  => color(view::dnrparcommune('17000',925)),//guernini
"926"  => color(view::dnrparcommune('17000',926)),//sidilaadjel
"927"  => color(view::dnrparcommune('17000',927)),//hassifdoul
"928"  => color(view::dnrparcommune('17000',928)),//elkhamis
"929"  => color(view::dnrparcommune('17000',929)),//birine
"930"  => color(view::dnrparcommune('17000',930)),//Dra Souary
"931"  => color(view::dnrparcommune('17000',931)),//benahar
"932"  => color(view::dnrparcommune('17000',932)),//hadshari
"933"  => color(view::dnrparcommune('17000',933)),//bouiratlahdab
"934"  => color(view::dnrparcommune('17000',934)),//ainfka
"935"  => color(view::dnrparcommune('17000',935)),//hassi bahbah
"936"  => color(view::dnrparcommune('17000',936)),//Mouilah
"937"  => color(view::dnrparcommune('17000',937)),//El Mesrane
"938"  => color(view::dnrparcommune('17000',938)),//Hassi el Mora
"939"  => color(view::dnrparcommune('17000',939)),//zaafrane
"940"  => color(view::dnrparcommune('17000',940)),//hassi el euche
"941"  => color(view::dnrparcommune('17000',941)),//ain maabed
"942"  => color(view::dnrparcommune('17000',942)),//darchioukh
"943"  => color(view::dnrparcommune('17000',943)),//Guendouza
"944"  => color(view::dnrparcommune('17000',944)),//El Oguila
"945"  => color(view::dnrparcommune('17000',945)),//El Merdja
"946"  => color(view::dnrparcommune('17000',946)),//mliliha
"947"  => color(view::dnrparcommune('17000',947)),//sidibayzid
"948"  => color(view::dnrparcommune('17000',948)),//Messad
"949"  => color(view::dnrparcommune('17000',949)),//Abdelmadjid
"950"  => color(view::dnrparcommune('17000',950)),//Haniet Ouled Salem
"951"  => color(view::dnrparcommune('17000',951)),//Guettara
"952"  => color(view::dnrparcommune('17000',952)),//Deldoul
"953"  => color(view::dnrparcommune('17000',953)),//Sed Rahal
"954"  => color(view::dnrparcommune('17000',954)),//Selmana
"955"  => color(view::dnrparcommune('17000',955)),//El Gahra
"956"  => color(view::dnrparcommune('17000',956)),//Oum Laadham
"957"  => color(view::dnrparcommune('17000',957)),//Mouadjebar
"958"  => color(view::dnrparcommune('17000',958)),//Ain el Ibel
"959"  => color(view::dnrparcommune('17000',959)),//Amera
"960"  => color(view::dnrparcommune('17000',960)),//N'thila
"961"  => color(view::dnrparcommune('17000',961)),//Oued Seddeur
"962"  => color(view::dnrparcommune('17000',962)),//Zaccar
"963"  => color(view::dnrparcommune('17000',963)),//Douis
"964"  => color(view::dnrparcommune('17000',964)),//Ain Chouhada
"965"  => color(view::dnrparcommune('17000',965)),//Tadmit
"966"  => color(view::dnrparcommune('17000',966)),//El Hiouhi
"967"  => color(view::dnrparcommune('17000',967)),//Faidh el Botma
"968"  => color(view::dnrparcommune('17000',968)) //Amourah
);

?>

<div style=" position:absolute;left:20px;top:320px;">
...
<text class="label" id="country_name1" x="250" y="45">Repartition Des donneurs Par Commune</text>  	  
<path  
   d="M 120  
       74 L 149  
       74 L 158  
...
d="M11,64 48,60 50,80 68,78 69,91 59,106 44,102 11,76 11,64"/><text class="commune" x="10" y="75">hassi fedoul</text>  
<path 
...
<path 
fill = "<?php echo $data['935'];?>"  stroke="black"onmouseover="displayName('hssi-bahbah')" 	
d="M154,144 141,148   108,163 113,171  124,171  125,180 139,181 152,185 157,195 159,200 176,192 181,188 179,183 185,181 191,177 184,173 187,170 181,163 177,156 177,150 170,149 163,145  154,144  141,149  108,163"/>    
<path 
...
<path 
fill = "<?php echo $data['940'];?>"  stroke="black"onmouseover="displayName('hssi-eleuche')" 	
