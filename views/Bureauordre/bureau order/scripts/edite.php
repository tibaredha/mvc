...
<body>
  ...
  <?php
    ...
    if (!(isset($_POST["type"])))
    {
      ...
      echo "<br><br><br><br>";
      echo "<H4><a href='Javascript:history.go(-1)'>Retour à la page editer message(s)</a><br>";
    }
    else
    {
      echo "<form action='confirm_edite.php' method='post' name='confirm_edite' enctype='multipart/form-data'>";
