...
<form method="post" action="<?php echo URL.'pdf/impdeces.php' ;?>">
	<label>Ordre</label><?php   combov1('ordre',array("Nom"=>"NOM","Prenom"=>"PRENOM","Date Deces"=>"DINS"));    ?><br />
	...
	<label>Structure</label><?php combov1('STRUCTURED',array("Tous Structure"=>"IS NOT NULL","EPH_DJELFA"=>"='1'","EPH_AIN_OUSSERA"=>"='2'","EPH_HASSI_BAHBAH"=>"='3'","EPH_MESSAAD"=>"='4'","EHS_DJELFA"=>"='5'"));   ?><br />
