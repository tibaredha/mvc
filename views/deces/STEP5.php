...
"butun"     => 'Section 6', 
"photos"    => '3.jpg',
"action"    => 'deces/STEP6/'.$this->user[0]['id'],
...
<div id="colborder">
	        ...
	        <ol>
				...
				<li <?php //if ($step == "requirements")    echo "class='current'"; ?>>Section 3 : histoire de la grossesse ayant entraîné le décès</li>
				<li <?php //if ($step == "filePermissions") echo "class='current'"; ?>>Section 4 : issue de la grossesse</li>
				<li <?php //if ($step == "database")        echo "class='current'"; ?>><b>Section 5 : enchaînement des événements ayant mené au décès</b></li>
