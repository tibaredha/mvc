...
if ($_POST['EPH']=='1') {$EPH1='EPH_DJALFA';$EPH="='1'";}
if ($_POST['EPH']=='2') {$EPH1='EPH_AIN_OUSSERA';$EPH="='2'";}
if ($_POST['EPH']=='3') {$EPH1='EPH_HASSI_BAHBAH';$EPH="='3'";}
if ($_POST['EPH']=='4') {$EPH1='EPH_MESSAAD';$EPH="='4'";}
if ($_POST['EPH']=='5') {$EPH1='EHS_DJELFA';$EPH="='5'";}
if ($_POST['EPH']=='6') {$EPH1='EPH_IDRISSIA';$EPH="='6'";}
if ($_POST['EPH']=='0') {$EPH1='WILAYA_DJELFA';$EPH="IS NOT NULL";}
