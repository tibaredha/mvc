...
<?php
View::fieldset("ss0","<strong>Identification</strong>");View::fieldset("ss","<strong>type vaccin</strong>");
...
$this->f0(URL.'scolaire/createvac/','post');
...
View::label($x+700,240,'bcg ');         View::chekbox($x+870,240,"CPS","CPS");
View::label($x+700,270,'dte polio rouvax 1ap ');         View::chekbox($x+870,270,"PPS","PPS");

View::label($x+925,240,'dte polio rouvax 1am');            View::chekbox($x+1095,240,"OS","OS");
View::label($x+925,270,'dta polio rouvax 1as');                 View::chekbox($x+1095,270,"PS","PS");
