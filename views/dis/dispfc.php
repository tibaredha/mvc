...
?>
<h2>Receveur: Distribution PFC </h2>
<br /><br />
<hr /><br />
<div class="tabbed_area">  
        <ul class="tabs">  
			...
			<li><a href="javascript:tabSwitch('tab_3', 'content_3');" id="tab_3">Poche : PFC</a></li> 	
        </ul>   
		...
		<input type="hidden" name="PSL"          value="PFC" />
		<p><?php //photosurl(1040,420,URL.'public/webcam/'.$this->user[0]['id'].'.jpg');?></p><br /><br /><br /><br />
		<p><?php photosurl(1040,420,URL.'public/images/photos/plasmas.jpg');?></p><br /><br /><br /><br />
		...
		<tr>
            <td  ><label>Date of distribution PFC </label></td>
            <td align="center"  ><input type="txt" name="DATEDIS"     value="<?php echo date ('Y-m-d')    ?>" />
			</td>	
		</tr>
		<tr>
            <td  ><label>HEURS of distribution PFC </label></td>
		...
		<tr>
            <td  ><label>Plasma frais congelé sécurisé par quarantaine (Date Peremption Desactive + Compatible Groupage Desactive) </label></td>
            <td align="center"  ><?php PSL('PFC',$this->user[0]['GRABO'],$this->user[0]['GRRH']);  ?>
			</td>	
		</tr>
			<tr>
		...
		<td align="center"  >
		<select name="DGC">
		<option value="1">Coagulopathie</option>
		</select><br />
		</td>	
		</td>	
		</tr>
