...
<div class="tabbed_area">  
        <ul class="tabs">  
			...
			<li><a href="javascript:tabSwitch('tab_3', 'content_3');" id="tab_3">Poche : CGR</a></li> 	
        </ul>   
		...
		<table  width='90%' border='1' cellpadding='5' cellspacing='1' align='center'>
        <tr class="header">
            <th>Receveur <?php echo $this->user[0]['NOM']."_". strtolower($this->user[0]['PRENOM']).'  Groupage : '.$this->user[0]['GRABO'].':'.$this->user[0]['GRRH']; ?> (1 CGR = 1g/dl HB)</th>
		...
		<tr>
            <td  ><label>Concentrés de Globules Rouges ISO GROUPE ISORH (Date Peremption Desactive + Compatible Groupage Desactive)   </label></td>
