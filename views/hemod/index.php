...
view::lang(1,'D:\wamp\www\mvc\views\hemod\langan.php');  
view::button('hemod','');
view::munu('hemod'); 
$colspan=14;
$c='hemod';     //controlleur
...
echo "<th style=\"width:50px;\">Pec</th>" ;
echo "<th style=\"width:50px;\">Aod</th>" ;
echo "<th style=\"width:50px;\">".Cert."</th>" ;

echo "</tr>" ;	
		foreach($this->userListview as $key => $value)
		{
			$fichier1 = "D:/wamp/www/mvc/public/webcam/".$dphotos."/".$value['id'].'.jpg' ;
			...
			echo"<td align=\"center\" class=\"bg-gray\" style=\"padding: 5px 5px;\"><button ".$disabled." title=\" View".$value['NOM'].', '.$value['PRENOM']."'s Record \" onclick=\" document.location='".URL.$c."/view/".$value['id']."'\"  >&nbsp;&nbsp;".'<img src="'.URL.'public/images/icons/open.PNG" width="16" height="16" border="0" alt=""/>'."&nbsp;&nbsp;</button></td>";
			...
			echo"<td align=\"center\" class=\"bg-gray\" style=\"padding: 5px 5px;\"><button ".$disabled." title=\" Seance".$value['NOM'].', '.$value['PRENOM']."'s Record \" onclick=\" document.location='".URL."hemod/news/".$value['id']."'\"  >&nbsp;&nbsp;".'<img src="'.URL.'public/images/icons/gs.jpg" width="16" height="16" border="0" alt=""/>'."&nbsp;&nbsp;</button></td>";
			...
			echo '<td align="center"><a title="Prise en charge '.trim($value['NOM']).', '.trim($value['PRENOM']).'  "   href="'.URL.'pdf/hemod/pec.php?id='.$value['id'].'"><img src="'.URL.'public/images/icons/print.PNG" width="16" height="16" border="0" alt=""/></a></td>';
			echo '<td align="center"><a title="Attestation '.trim($value['NOM']).', '.trim($value['PRENOM']).'  "   href="'.URL.'tcpdf/hemod/attestation.php?id='.$value['id'].'"><img src="'.URL.'public/images/icons/print.PNG" width="16" height="16" border="0" alt=""/></a></td>';
		    echo '<td align="center"><a title="Certificat '.trim($value['NOM']).', '.trim($value['PRENOM']).'  "   href="'.URL.'tcpdf/hemod/certificat.php?id='.$value['id'].'"><img src="'.URL.'public/images/icons/print.PNG" width="16" height="16" border="0" alt=""/></a></td>';
