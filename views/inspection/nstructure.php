...
$this->label($x,$y+437,'__________________________________________________________________________________________________________________');
$this->label($x,$y+460,'Realisation');       $this->txts($x+100,$y+450,'REALISATION',0,$data['REALISATION'],'dateus3');                      $this->label($x+700,$y+460,'N° Realisation');             $this->txt($x+800,$y+450,'NREALISATION',0,$data['NREALISATION'],'date');
$this->label($x,$y+490,'Ouverture');         $this->txts($x+100,$y+480,'OUVERTURE',0,$data['OUVERTURE'],'dateus4');                          $this->label($x+700,$y+490,'N° Ouverture');               $this->txt($x+800,$y+480,'NOUVERTURE',0,$data['NOUVERTURE'],'date');
$this->label($x,$y+500,'__________________________________________________________________________________________________________________');
$this->label($x+990,$y+530,'اللقب');         $this->txtarid($x+690,$y+520,'NOMAR','NOMAR',0,$data['NOMAR'],'date');                          $this->label($x+625,$y+530,'الاســـــــم');                $this->txtarid($x+340,$y+520,'PRENOMAR','PRENOMAR',0,$data['PRENOMAR'],'date');                          $this->label($x+290,$y+530,'العنوان');       $this->txtarid($x,$y+520,'ADRESSEAR','ADRESSEAR',0,$data['ADRESSEAR'],'date');
$y=60;
$this->submit($x+800,$y+430+90,$data['butun']);
$this->f1();
view::sautligne(19);
ob_end_flush();
?>
