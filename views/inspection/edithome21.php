...
"action"     => 'inspection/edit1home21/'.$this->home[0]['id'],
...
$this->label($x,$y+340,'Garage : ');             $this->date1($x+150,$y+330,'CDS0',10,'00','cds();');$this->date1($x+225,$y+330,'CDS1',10,'00','cds();');  $this->date1($x+300,$y+330,'CDS',0,$this->home[0]['CDS0'],'cds();');
$this->label($x,$y+380,'Bureau : ');             $this->date1($x+150,$y+370,'SDS0',10,'00','sds();');$this->date1($x+225,$y+370,'SDS1',10,'00','sds();');  $this->date1($x+300,$y+370,'SDS',0,$this->home[0]['SDS0'],'sds();');
$this->label($x,$y+420,"Salle de stokage : ");   $this->date1($x+150,$y+410,'SAH0',10,'00','sah();');$this->date1($x+225,$y+410,'SAH1',10,'00','sah();');$this->date1($x+300,$y+410,'SAH',0,$this->home[0]['SAH0'],'sah();');
$this->label($x,$y+460,"Autres : ");             $this->date1($x+150,$y+450,'SAF0',10,'00','saf();');$this->date1($x+225,$y+450,'SAF1',10,'00','saf();');$this->date1($x+300,$y+450,'SAF',0,$this->home[0]['SAF0'],'saf();');
...
$this->label($x+400,$y+380,'Groupe');            $this->chekboxvx($x+470,$y+375,"groupe",View::verif($this->home[0]['groupe'],'1')); $this->combopharmacieng($x+520,$y+370,"PHA4",$this->home[0]['PHA4'],View::nbrtostring('structure','id',$this->home[0]['PHA4'],'NOM')."_".View::nbrtostring('structure','id',$this->home[0]['PHA4'],'PRENOM'),"pharmacie",21);
$this->label($x+400,$y+420,'1er transporteur');  $this->combopharmacien($x+520,$y+410,"PHA1",$this->home[0]['PHA1'],$this->home[0]['PHA1'],"pharmacie",21);   $this->label($x+800,$y+420,'Distance 1 ');$this->txt($x+880,$y+410,'DIST1',0,$this->home[0]['DIST1']);
$this->label($x+400,$y+460,'2em transporteur');  $this->combopharmacien($x+520,$y+450,"PHA2",$this->home[0]['PHA2'],$this->home[0]['PHA2'],"pharmacie",21);   $this->label($x+800,$y+460,'Distance 2 ');$this->txt($x+880,$y+450,'DIST2',0,$this->home[0]['DIST2']);
