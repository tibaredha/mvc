...
"action"     => 'tcpdf/inspection/pvconf.php?uc='.$this->user[0]['id'],
...
$this->label($x,$y+340,'Garage '); $this->txt($x+150,$y+330,'GRG',0,"00");
$this->label($x,$y+380,'Bureau');$this->txt($x+150,$y+370,'BRE',0,"00");
$this->label($x,$y+420,"Salle de stokage ");     $this->txt($x+150,$y+410,'SDS',0,"00");
$this->label($x,$y+460,"Numero telephone ");     $this->txts($x+150,$y+450,'Mobile',0,"",'port');
