...
"action"     => 'inspection/creathome21/'.$this->user[0]['id'],
...
$this->label($x+400,$y+500,'3em transporteur');   $this->combopharmacien($x+520,$y+490,"PHA3","","","pharmacie",21);   $this->label($x+800,$y+500,'Distance 3 '); $this->txt($x+880,$y+490,'DIST3',0,"00");
...
<table  width='100%' border='1' cellpadding='5' cellspacing='1' align='center'>
		...
		{		
				foreach($this->userListview as $key => $value){ ?>
						...
						<?php    
					    echo "<td style=\"width:10px;\" align=\"center\" ><a title=\"PV de conformite\"      href=\"".URL.'tcpdf/inspection/conf21.php?ids='.$this->user[0]['id']."&idh=".$value['id']."\" ><img  src=\"".URL.'public/images/icons/document-pdf.png'."\"  width='16' height='16' border='0' alt='' ></a>  </td>" ;
