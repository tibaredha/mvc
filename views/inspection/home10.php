...
"action"     => 'inspection/creathome10/'.$this->user[0]['id'],
...
$this->label($x,$y+340,"Salles d'hémodialyse :");         $this->date1($x+150,$y+330,'CDS0',10,'00','cds();');$this->date1($x+225,$y+330,'CDS1',10,'00','cds();');  $this->date1($x+300,$y+330,'CDS',0,"00",'cds();');
$this->label($x,$y+380,'Cabinets de toilettes : ');       $this->date1($x+150,$y+370,'SDS0',10,'00','sds();');$this->date1($x+225,$y+370,'SDS1',10,'00','sds();');  $this->date1($x+300,$y+370,'SDS',0,"00",'sds();');
$this->label($x,$y+420,"Salle d'urgence : ");             $this->date1($x+150,$y+410,'SAH0',10,'00','sah();');$this->date1($x+225,$y+410,'SAH1',10,'00','sah();');$this->date1($x+300,$y+410,'SAH',0,"00",'sah();');
$this->label($x,$y+460,"Salle d'isolement : ");           $this->date1($x+150,$y+450,'SAF0',10,'00','saf();');$this->date1($x+225,$y+450,'SAF1',10,'00','saf();');$this->date1($x+300,$y+450,'SAF',0,"00",'saf();');
$this->label($x,$y+500,"La station d'eau ");              $this->date1($x+150,$y+490,'SAN0',10,'00','san();');$this->date1($x+225,$y+490,'SAN1',10,'00','san();');$this->date1($x+300,$y+490,'SAN',0,"00",'san();');
$this->label($x,$y+540,"Salle de stérilisation ");        $this->date1($x+150,$y+530,'STE0',10,'00','ste();');$this->date1($x+225,$y+530,'STE1',10,'00','ste();');$this->date1($x+300,$y+530,'STE',0,"00",'ste();');
...
$this->label($x+400,$y+460,'2em centre');   $this->combopharmacien($x+520,$y+450,"PHA2","","","pharmacie",10);   $this->label($x+800,$y+460,'Distance 2 ');$this->txt($x+880,$y+450,'DIST2',0,"00");
$this->label($x+400,$y+500,'3em centre');   $this->combopharmacien($x+520,$y+490,"PHA3","","","pharmacie",10);   $this->label($x+800,$y+500,'Distance 3 '); $this->txt($x+880,$y+490,'DIST3',0,"00");
...
<table  width='100%' border='1' cellpadding='5' cellspacing='1' align='center'>
		...
		{		
				foreach($this->userListview as $key => $value){ ?>
						...
						<?php    
					    echo "<td style=\"width:10px;\" align=\"center\" ><a title=\"PV de conformite\"      href=\"".URL.'tcpdf/inspection/conf10.php?ids='.$this->user[0]['id']."&idh=".$value['id']."\" ><img  src=\"".URL.'public/images/icons/document-pdf.png'."\"  width='16' height='16' border='0' alt='' ></a>  </td>" ;
	                    if($value['NAT']==1){echo "<td style=\"width:10px;\" align=\"center\" ><a title=\"Decision_changement\"   href=\"".URL.'tcpdf/inspection/tran10.php?ids='.$this->user[0]['id']."&idh=".$value['id']."\" ><img  src=\"".URL.'public/images/icons/document-pdf.png'."\"  width='16' height='16' border='0' alt='' ></a></td>" ;}
						if($value['NAT']==2){echo "<td style=\"width:10px;\" align=\"center\" ><a title=\"Decision_installation\" href=\"".URL.'tcpdf/inspection/inst10.php?ids='.$this->user[0]['id']."&idh=".$value['id']."\" ><img  src=\"".URL.'public/images/icons/document-pdf.png'."\"  width='16' height='16' border='0' alt='' ></a></td>" ;}
						if($value['NAT']==3){echo "<td style=\"width:10px;\" align=\"center\" ><a title=\"Decision_ouverture\"    href=\"".URL.'tcpdf/inspection/ouve10.php?ids='.$this->user[0]['id']."&idh=".$value['id']."\" ><img  src=\"".URL.'public/images/icons/document-pdf.png'."\"  width='16' height='16' border='0' alt='' ></a></td>" ;}
						if($value['NAT']==4){echo "<td style=\"width:10px;\" align=\"center\" ><a title=\"Decision_Fermeture\"    href=\"".URL.'tcpdf/inspection/ferm10.php?ids='.$this->user[0]['id']."&idh=".$value['id']."\" ><img  src=\"".URL.'public/images/icons/document-pdf.png'."\"  width='16' height='16' border='0' alt='' ></a></td>" ;}
						?>
						
						<td align="center"><a title="editer" href="<?php echo URL.'inspection/edithome10/'.$value['id'].'/'.$value['idstructure'];?>"><img src='<?php echo URL.'public/images/icons/edit.PNG';?>' width='16' height='16' border='0' alt=''/></a></td>
						<td align="center"><a class="delete" title="supprimer" href="<?php echo URL.'inspection/deletehome10/'.$value['id'].'/'.$value['idstructure'];?>"><img src='<?php echo URL.'public/images/icons/delete.PNG';?>' width='16' height='16' border='0' alt=''/></a></td>	
						</tr>
				<?php 
				}
...
function ste(){var a = parseFloat(this.document.form1.STE0.value);var b = parseFloat(this.document.form1.STE1.value);var result =  parseFloat(a * b).toFixed(2);this.document.form1.STE.value = result;}
function phr(){var a = parseFloat(this.document.form1.PHR0.value);var b = parseFloat(this.document.form1.PHR1.value);var result =  parseFloat(a * b).toFixed(2);this.document.form1.PHR.value = result;}
function lab(){var a = parseFloat(this.document.form1.LAB0.value);var b = parseFloat(this.document.form1.LAB1.value);var result =  parseFloat(a * b).toFixed(2);this.document.form1.LAB.value = result;}
