...
"action"     => 'inspection/edit1home16/'.$this->home[0]['id'],
...
$this->label($x+400,$y+380,'Groupe');               $this->chekboxvx($x+470,$y+375,"groupe",View::verif($this->home[0]['groupe'],'1')); $this->combopharmacieng($x+520,$y+370,"PHA4",$this->home[0]['PHA4'],View::nbrtostring('structure','id',$this->home[0]['PHA4'],'NOM')."_".View::nbrtostring('structure','id',$this->home[0]['PHA4'],'PRENOM'),"pharmacie",16);

$this->label($x+400,$y+420,'1er specialiste');      $this->combopharmacien($x+520,$y+410,"PHA1",$this->home[0]['PHA1'],$this->home[0]['PHA1'],"pharmacie",16);   $this->label($x+800,$y+420,'Distance 1 ');$this->txt($x+880,$y+410,'DIST1',0,$this->home[0]['DIST1']);
$this->label($x+400,$y+460,'2em specialiste');      $this->combopharmacien($x+520,$y+450,"PHA2",$this->home[0]['PHA2'],$this->home[0]['PHA2'],"pharmacie",16);   $this->label($x+800,$y+460,'Distance 2 ');$this->txt($x+880,$y+450,'DIST2',0,$this->home[0]['DIST2']);
$this->label($x+400,$y+500,'3em specialiste');      $this->combopharmacien($x+520,$y+490,"PHA3",$this->home[0]['PHA3'],$this->home[0]['PHA3'],"pharmacie",16);   $this->label($x+800,$y+500,'Distance 3 '); $this->txt($x+880,$y+490,'DIST3',0,$this->home[0]['DIST3']);
