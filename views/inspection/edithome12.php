...
$this->label($x,$y+340,'Salle des ventes : ');      $this->date1($x+150,$y+330,'CDS0',10,'00','cds();');$this->date1($x+225,$y+330,'CDS1',10,'00','cds();');  $this->date1($x+300,$y+330,'CDS',0,$this->home[0]['CDS0'],'cds();');
...
$this->label($x,$y+420,"Salle de préparation : ");  $this->date1($x+150,$y+410,'SAH0',10,'00','sah();');$this->date1($x+225,$y+410,'SAH1',10,'00','sah();');  $this->date1($x+300,$y+410,'SAH',0,$this->home[0]['SAH0'],'sah();');
...
$this->label($x+400,$y+500,'3em pharmacien');       $this->combopharmacien($x+520,$y+490,"PHA3",$this->home[0]['PHA3'],$this->home[0]['PHA3'],"pharmacie",12);   $this->label($x+800,$y+500,'Distance 3 '); $this->txt($x+880,$y+490,'DIST3',0,$this->home[0]['DIST3']);
