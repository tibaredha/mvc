...
"action"     => 'tcpdf/inspection/decision_12_c.php?uc='.$this->user[0]['id'],
...
echo "<h2>PV de changement du local de : ".strtoupper($this->user[0]['NOM'])."_".$this->user[0]['PRENOM']." ( ".$this->stringtostring("structurebis","id",$this->user[0]['STRUCTURE'],"structure") ." ) "."</h2 ><hr /><br />";
...
$this->label($x,$y+340,'Ouverture N ');             $this->txt($x+150,$y+330,'NUMOUVERTURE',0,"00");                $this->label($x+400,$y+340,'Date ouverture');  $this->txts($x+520,$y+330,'DATEOUV',0,date('j-m-Y'),'dateus3');
