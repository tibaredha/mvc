...
{	
        ...
        ?>
			...
			<td align="center" >  <?php echo $value['IDPFC'];    ?></td>
			...
			<td align="center"><a title="editer <?php echo trim($value['IDPFC']);?>'s Record"                        href="<?php echo URL.'stock/editpfc/'.$value['IDPFC'];?>">      <img src="<?php echo URL.'public/images/icons/edit.PNG';?>"   width='16' height='16' border='0' alt=''/></a></td>
			<td align="center"><a title="supprimer <?php echo trim($value['IDPFC']);?>'s Record"  class="delete"     href="<?php echo URL.'stock/deletepfc/'.$value['IDPFC'];?>">    <img src="<?php echo URL.'public/images/icons/delete.PNG';?>" width='16' height='16' border='0' alt=''/></a></td>
			<td align="center"><a title="fiche stock <?php echo trim($value['IDPFC']);?>'s Record"                   href="<?php echo URL.'pdf/stock.php?uc='.$value['IDPFC'];?>">   <img src="<?php echo URL.'public/images/icons/print.PNG';?>"  width='16' height='16' border='0' alt=''/></a></td>
			</tr>
        <?php 
		}
		...
		if ($total_count <= 0 )
		{
		echo '<tr><td align="center" colspan="13" ><span> No record found for pfc </span></td> </tr>';
