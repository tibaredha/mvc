...
<div class="tabbed_area">  
		...
		{		
				foreach($this->userListview as $key => $value){ ?>
						...
						<td align="center" class="bg-gray" style="padding: 5px 5px;"><button onclick="document.location='<?php echo URL.'dnr/viewdon/'.$value['IDDND'];?>'"   title="View fiche don  <?php   echo $value['id'].', '.$value['id']?>'s Record">&nbsp;&nbsp;<img src="<?php echo URL.'public/images/icons/open.PNG';?>" width='16' height='16' border='0' alt=''/>&nbsp;&nbsp;</button></td>
			            <td align="center" class="bg-gray" style="padding: 5px 5px;"><button onclick="document.location='<?php echo URL.'dnr/Donatedon/'.$value['IDDND'];?>'" title="ettiquetage <?php echo $value['id'].', '.$value['id']?>'s Record" <?php //echo ($allow_donate==FALSE)?'disabled':'';?> >&nbsp;&nbsp;<img src="<?php echo URL.'public/images/icons/b_views.PNG';?>" width='16' height='16' border='0' alt=''/>&nbsp;&nbsp;</button></td>       
						<td align="center" class="bg-gray" style="padding: 5px 5px;"><button onclick="document.location='<?php echo URL.'dnr/Donatedon/'.$value['IDDND'];?>'" title="resultat qualification <?php echo $value['id'].', '.$value['id']?>'s Record" <?php //echo ($allow_donate==FALSE)?'disabled':'';?> >&nbsp;&nbsp;<img src="<?php echo URL.'public/images/icons/print.PNG';?>" width='16' height='16' border='0' alt=''/>&nbsp;&nbsp;</button></td>       
