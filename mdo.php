...
echo '</br>';
 ...
 $sql=mysql_query("SELECT * FROM epsp_hbb ");
echo "<table  width='90%' border='1' cellpadding='5' cellspacing='1' align='center'>" ;
 ...
 while($value=mysql_fetch_array($sql))
	...
	$sql1 = "INSERT INTO mdo1 (STRUCTURE,DATEMDO,NOMPRENOM,AGE,SEXE,WILAYAN,COMMUNE,ADRESS,MDO,OBSERVATION) 
	                     VALUES ('".$value['STRUCTURE']."','".$value['DATEMDO']."','".$value['NOMPRENOM']."','".$value['AGE']."','".$value['SEXE']."','17000','".$value['COMMUNE']."','".$value['ADRESS']."','".$value['MDO']."','".$value['OBSERVATION']."');";
