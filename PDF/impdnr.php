...
$SEXE=$_POST['SEXE'];
$date=date("d-m-y");
$pdf->entetepage1('LISTE NOMINATIVE DES DONNEURS');
...
$query="select * from dnr   where   GRABO $groupage  AND  GRRH $rhesus   AND    SEX $SEXE   order by $ordre $ascdesc limit $nbrlimit          "; //% %will search form 0-9,a-z  order by $ordre $ascdesc limit $nbrlimit
