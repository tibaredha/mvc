...
$SEXE=$_POST['SEXE'];
$date=date("d-m-y");
$pdf->entetepage1('LISTE NOMINATIVE DES PATIENTS');
$pdf->SetFillColor(230);//fond gris il faut ajouter au cell un autre parametre pour qui accepte la coloration
$pdf->SetTextColor(0,0,0);//text noire
$pdf->SetFont('Times', 'B', 11);
$h=40;
$pdf->SetXY(05,$h);$pdf->cell(20,5,"IDDNR",1,0,'C',1,0);
...
$query="select * from pat where   GRABO $groupage  AND  GRRH $rhesus   AND    SEX $SEXE   order by $ordre $ascdesc limit $nbrlimit          "; //% %will search form 0-9,a-z  order by $ordre $ascdesc limit $nbrlimit
