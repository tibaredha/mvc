...
$pdf->entetepage1('LISTE NOMINATIVE DES MALADES');
$h=40;


$pdf->SetXY(5,$h);$pdf->cell(20,5,"ID",1,0,'C',1,0);
...
$pdf->SetXY(195,$h);$pdf->cell(25,5,"DDQ",1,0,'C',1,0);
$pdf->SetXY(220,$h);$pdf->cell(25,5,"DPQ",1,0,'C',1,0);
...
$query="select * from mal where   GRABO $groupage  AND  GRRH $rhesus   AND    SEX $SEXE   order by $ordre $ascdesc limit $nbrlimit          "; //% %will search form 0-9,a-z  order by $ordre $ascdesc limit $nbrlimit
...
while($row=mysql_fetch_object($resultat))
  {
   ...
   $pdf->cell(25,8,trim($row->DQ),1,0,'C',0);
   $pdf->cell(25,8,trim($row->DQ),1,0,'C',0);
