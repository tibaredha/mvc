...
$reportName2 = 'Agence Nationale du Sang ';
$reportName3 = 'Etablissement public hospitalier ain oussera ';
$reportName4 = "RAPPORT D'ACTIVITÉ";
$reportName5 = "DE LA TRANSFUSION SAGUINE";
$reportName6 = "Collecte du ".$t;
...
"D"    => '40-60',
"E"    => '60-100',
"1"    => $pdf->donparcommune('17000',916) ,//daira  djelfa
"2"    => $pdf->donparcommune('17000',924)+$pdf->donparcommune('17000',925),//daira  ainoussera
"3"    => $pdf->donparcommune('17000',929)+$pdf->donparcommune('17000',931),//daira  birine
...
$pdf->AddPage();
$pdf->Ln( 0 );
$pdf->Write( 6, html_entity_decode(utf8_decode("Répartition des dons par tranche d'age ( 05 ans ) et sexe,Pyramide des âges de la population des donneurs")) );
