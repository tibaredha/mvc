...
{ 
	...
	$this->SetTextColor(225,0,0);
	$this->Text(5,45,$row['id']);
	$this->Text(5,60,"Date:".date('d/m/Y'));
	$this->Text(182,40,$row['GRABO']);
	$this->Text(182,45,$row['GRRH']);
	$this->Text(15,80,$row['NOM']);
	$this->Text(100,80,$row['PRENOM']);
	$this->Text(175,80,$row['SEX']);
	$this->Text(20,90,$row['DATENAISSANCE']);
	$this->Text(175,90,substr(date('Y-m-d'),0,4)-substr($row['DATENAISSANCE'],6,4)." ans");
	$this->Text(42,110+8,$this->nbrtostring($this->db_name,"wil","IDWIL",$row['WILAYA'],"WILAYAS"));$this->Text(84+42,110+8,$this->nbrtostring($this->db_name,"com","IDCOM",$row['COMMUNE'],"COMMUNE"));
	$this->Text(42,120+8,$this->nbrtostring($this->db_name,"wil","IDWIL",$row['WILAYAR'],"WILAYAS"));$this->Text(84+42,120+8,$this->nbrtostring($this->db_name,"com","IDCOM",$row['COMMUNER'],"COMMUNE"));
...
//***************************************************RESULTAT DON **********************************************************************************//
	...
	{
	return $RESVIDEE=$RESVIDE;
	}
	}
	
	function RESMALPDF($idon)
	{
	$this->mysqlconnect();
	$sql = "SELECT * FROM MAL WHERE id = ".$idon ;
	...
	$this->Code39(33,40 ,$result->id, $baseline=0.5, $height=5);
	$this->SetXY(5,48);$this->Cell(20,8,'Poids : '.'---'.' '.'kg',0,1,'r');
	$this->SetXY(5,56);$this->Cell(20,8,'SYS/DIA : '.'---'.'/'.'---'.' '.'mmhg',0,1,'r');
	$this->SetXY(5,56+8);$this->Cell(20,8,'Date Prelevement : '.$this->dateUS2FR($result->DQ),0,1,'r');
	$this->SetXY(36,85+8);$this->Cell(30,8,$this->RESVIDE($result->GRABO).' / '.$this->RESVIDE($result->GRRH),0,1,'C'); 
	$this->SetXY(66,85+8);$this->Cell(40,8,'**********',0,1,'C');  
	$this->SetXY(106,85+8);$this->Cell(32,8,'**********',0,1,'C');  
	$this->SetXY(6,85+8+8);$this->Cell(30,8,'HVB:',0,1,'r'); 
	$this->SetXY(36,85+8+8);$this->Cell(30,8,ucfirst($this->RESVIDE($result->HVB)),0,1,'C'); 
	$this->SetXY(66,85+8+8);$this->Cell(40,8,'Négatif',0,1,'C');  
	$this->SetXY(106,85+8+8);$this->Cell(32,8,'**********',0,1,'C');  
    $this->SetXY(6,85+8+8+8);$this->Cell(30,8,'HVC:',0,1,'r'); 
	$this->SetXY(36,85+8+8+8);$this->Cell(30,8,ucfirst($this->RESVIDE($result->HVC)),0,1,'C'); 
	$this->SetXY(66,85+8+8+8);$this->Cell(40,8,'Négatif',0,1,'C');  
	$this->SetXY(106,85+8+8+8);$this->Cell(32,8,'**********',0,1,'C');  
	$this->SetXY(6,85+8+8+8+8);$this->Cell(30,8,'HIV:',0,1,'r'); 
	$this->SetXY(36,85+8+8+8+8);$this->Cell(30,8,ucfirst($this->RESVIDE($result->HIV)),0,1,'C'); 
	$this->SetXY(66,85+8+8+8+8);$this->Cell(40,8,'Négatif',0,1,'C');  
	$this->SetXY(106,85+8+8+8+8);$this->Cell(32,8,'**********',0,1,'C');  
	$this->SetXY(6,85+8+8+8+8+8);$this->Cell(30,8,'VDRL:',0,1,'r'); 
	$this->SetXY(36,85+8+8+8+8+8);$this->Cell(30,8,trim(ucfirst($this->RESVIDE($result->TPHA))),0,1,'C'); 
	$this->SetXY(66,85+8+8+8+8+8);$this->Cell(40,8,'Négatif',0,1,'C');  
	$this->SetXY(106,85+8+8+8+8+8);$this->Cell(32,8,'**********',0,1,'C'); 
