<?php
require('../invoice.php');
class MORSC extends PDF_Invoice
{ 
...
//*************poure mettre le celle en verticale 	
	...
	function mors($COMMUNE,$ANIMAL,$MORSGRIF,$datejour1,$datejour2,$STRUCTURED) //chsl$structure,$mdo	STRUCTURE $structure and  MDO='$mdo' 
	{
	$this->mysqlconnect();
	$requete="SELECT * FROM mors where STRUCTURE $STRUCTURED  and  COMMUNE =$COMMUNE   and  ANIMAL=$ANIMAL  and  MORSGRIF=$MORSGRIF  and  (DATEMORS BETWEEN '$datejour1' AND '$datejour2') ";//
	...
	function morst($ANIMAL,$MORSGRIF,$datejour1,$datejour2,$STRUCTURED) //chsl$structure,$mdo	STRUCTURE $structure and  MDO='$mdo' 
	{
	$this->mysqlconnect();
	$requete="SELECT * FROM mors where  STRUCTURE $STRUCTURED  and   ANIMAL=$ANIMAL  and  MORSGRIF=$MORSGRIF  and  (DATEMORS BETWEEN '$datejour1' AND '$datejour2') ";//
	$requete = @mysql_query($requete) or die($requete."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	}
	function ragedeces($ragedeces0,$ragedeces1,$datejour1,$datejour2,$STRUCTURED) //chsl$structure,$mdo	STRUCTURE $structure and  MDO='$mdo' 
	{
	$this->mysqlconnect();
	$requete="SELECT * FROM mors where STRUCTURE $STRUCTURED  and     $ragedeces0=$ragedeces1   and  (DATEMORS BETWEEN '$datejour1' AND '$datejour2') ";//
	$requete = @mysql_query($requete) or die($requete."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	...
	function mors1($ANIMAL,$MORSGRIF,$datejour1,$datejour2,$STRUCTURED) //$COMMUNE,   COMMUNE =$COMMUNE   and   
	{
	$this->mysqlconnect();
	$requete="SELECT * FROM mors where STRUCTURE $STRUCTURED  and ANIMAL=$ANIMAL  and MORSGRIF=$MORSGRIF  and  (DATEMORS BETWEEN '$datejour1' AND '$datejour2')";//
	$requete = @mysql_query($requete) or die($requete."<br>".mysql_error());
	...
	function mors2($ANIMAL,$MORSGRIF,$datejour1,$datejour2,$vs0,$vs1,$STRUCTURED)  
	{
	$this->mysqlconnect();
	$requete="SELECT * FROM mors where STRUCTURE $STRUCTURED  and  ANIMAL=$ANIMAL  and  MORSGRIF=$MORSGRIF  and  $vs0=$vs1  and  (DATEMORS BETWEEN '$datejour1' AND '$datejour2')";//
	$requete = @mysql_query($requete) or die($requete."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
