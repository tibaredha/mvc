<?php
require('../invoice.php');
class BNMC extends PDF_Invoice
{ 
...
//*************poure mettre le celle en verticale 	
	...
	{
	$this->mysqlconnect();
	$req="SELECT $col  FROM bordereau where  COMMUNEN='$communen' and  mois='$mois' and  annee='$annee'  ";
	...
	function sumbnm($col,$mois,$annee) //somme verticale des affection depiste
	{
	$this->mysqlconnect();
	...
	if ($col=='m') 
	{
	$req="SELECT dm1+dm2+dm3+dm4+dm5+dm6+dm7+dm8+dm9+dm10+dm11+dm12+dm13+dm14+dm15+dm16+dm17+dm18+dm19+djm1 as dmf  FROM bordereau where  COMMUNEN='$communen' and  mois='$mois' and  annee='$annee'  ";
	}
	if ($col=='f') 
	{
	$req="SELECT df1+df2+df3+df4+df5+df6+df7+df8+df9+df10+df11+df12+df13+df14+df15+df16+df17+df18+df19+djf1 as dmf  FROM bordereau where  COMMUNEN='$communen' and  mois='$mois' and  annee='$annee'  ";
	}
	$query = mysql_query($req);   
	$rs = mysql_fetch_assoc($query);
	if (isset($rs['dmf'])) 
	...
	function sumad($col) //somme verticale des affection depiste
	{
	$this->mysqlconnect();
	$req="SELECT SUM($col) AS SAD FROM scolaire";
	$query = mysql_query($req);   
	$rs = mysql_fetch_assoc($query);
	$OP=$rs['SAD'];
	mysql_free_result($query);
	...
	function sumhs($col) //somme verticale hygienne et salubrite des locaux
	{
	$this->mysqlconnect();
	$req="SELECT SUM($col) AS SAD FROM chsl";
	$query = mysql_query($req);   
	$rs = mysql_fetch_assoc($query);
	$OP=$rs['SAD'];
	mysql_free_result($query);
	...
	function counteta($val) //chsl
	{
	$this->mysqlconnect();
	$requete="SELECT * FROM chsl where COMMUNER='$val' GROUP BY ETA ";//
	$requete = @mysql_query($requete) or die($requete."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	}
	function countetat() //chsl
	{
	$this->mysqlconnect();
	$requete="SELECT * FROM chsl  GROUP BY ETA ";//
	$requete = @mysql_query($requete) or die($requete."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	...
	function counteta1($val) //nombre etablissement par commune 
	{
	$this->mysqlconnect();
	$requete="SELECT * FROM etabscolaire where COMMUNEN='$val' GROUP BY ETA ";//
	$requete = @mysql_query($requete) or die($requete."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	}
	function counteta1t() //nombre etablissement par commune 
	{
	$this->mysqlconnect();
	$requete="SELECT * FROM etabscolaire  GROUP BY ETA ";//
	$requete = @mysql_query($requete) or die($requete."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	}
	function counteta2($val) //nombre cantine par commune 
	{
	$this->mysqlconnect();
	$requete="SELECT * FROM etabscolaire where COMMUNEN='$val'  and  CANTINE='1'  GROUP BY ETA ";//
	$requete = @mysql_query($requete) or die($requete."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	}
	function counteta2t() //nombre cantine par commune 
	{
	$this->mysqlconnect();
	$requete="SELECT * FROM etabscolaire where CANTINE='1'  GROUP BY ETA ";//
	$requete = @mysql_query($requete) or die($requete."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	}
	function counteta3($val) //nombre etablissement par visite
	{
	$this->mysqlconnect();
	$requete="SELECT * FROM scolaire where COMMUNEN='$val' GROUP BY ETA  ";//and  CANTINE='1'  
	$requete = @mysql_query($requete) or die($requete."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	}
	function counteta3t() //nombre etablissement par visite
	{
	$this->mysqlconnect();
	$requete="SELECT * FROM scolaire  GROUP BY ETA  ";  
	$requete = @mysql_query($requete) or die($requete."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	}
	function eleveexamine($val) //nombre eleve par commune
	{
	$this->mysqlconnect();
	$requete="SELECT * FROM scolaire where COMMUNER='$val' ";  
	$requete = @mysql_query($requete) or die($requete."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	...
	function eleveexaminex($val,$val0) //nombre eleve par commune et par  x
	{
	$this->mysqlconnect();
	$requete="SELECT * FROM scolaire where COMMUNER='$val' and $val0=1 ";  
	$requete = @mysql_query($requete) or die($requete."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
