...
while($row=mysql_fetch_object($resultat))
{
	...
	$pdf->SetXY(42,63.5);$pdf->Write(0,html_entity_decode(utf8_decode(nbrtostring('WIL','IDWIL',$row->WILAYAD,'WILAYAS'))));$pdf->SetXY(42,59.5);$pdf->Write(0,html_entity_decode(utf8_decode(nbrtostring('com','IDCOM',$row->COMMUNED,'COMMUNE'))));
	...
	$pdf->SetXY(48,81.7);$pdf->Write(0,$row->DATENAISSANCE);$pdf->SetXY(85,81.7);$pdf->Write(0,html_entity_decode(utf8_decode(nbrtostring('com','IDCOM',$row->COMMUNE,'COMMUNE'))));
	...
	$pdf->SetXY(143,108);$pdf->Write(0,$row->MEDECINHOSPIT);//.$row->USER
