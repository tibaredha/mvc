...
//*************poure mettre le celle en verticale 	
	...
	while($row=mysql_fetch_object($res))
	{
		...
		if ($tot2 > 0) {
		 while($row1=mysql_fetch_object($res1))
			...
			{
			$this->SetFillColor(200);$this->cell(27,5,$this->NBRANNOMALIE($row1->id,0),1,0,'C',1,0);
			} else {
			$this->SetFillColor(248);$this->cell(27,5,'0',1,0,'C',0);
			}
			
			if ($this->NBRANNOMALIE($row1->id,0)==1) 
			{
			$this->SetFillColor(200);$this->cell(26,5,$this->NBRANNOMALIE($row1->id,1),1,0,'C',1,0);
			} else {
			$this->SetFillColor(248);$this->cell(26,5,'0',1,0,'C',0);
			}
	...
	while($row=mysql_fetch_object($res))
	{
		...
		$this->cell(59,5,'Adresse',1,0,'L',1,0);
		$this->cell(18,5,'Date',1,0,'C',1,0);
		$this->cell(18,5,'Laboratoire',1,0,'C',1,0);
		$this->cell(18,5,'Fonctionnel',1,0,'C',1,0);
		$this->cell(17,5,'Decision',1,0,'C',1,0);
		$query1 = "SELECT * from structure where  STRUCTURE $EPH  and COMMUNE=$row->IDCOM and ETAT=0 ORDER BY NOM"; 
		$res1=mysql_query($query1);
		$tot2=mysql_num_rows($res1);
		$this->SetXY(5,$this->GetY()+5); 
	...
	while($row=mysql_fetch_object($res))
	{
		...
		$this->cell(59,5,'Adresse',1,0,'L',1,0);
		$this->cell(18,5,'Date',1,0,'C',1,0);
		$this->cell(18,5,'Autoclave',1,0,'C',1,0);
		$this->cell(18,5,'Fonctionnel',1,0,'C',1,0);
		$this->cell(17,5,'Decision',1,0,'C',1,0);
		$query1 = "SELECT * from structure where  STRUCTURE $EPH  and COMMUNE=$row->IDCOM and ETAT=0 ORDER BY NOM"; 
		$res1=mysql_query($query1);
	...
	while($row=mysql_fetch_object($res))
	{
		$this->cell(200,5,"Commune : ".$row->COMMUNE,1,0,'L',1,0);
		$this->SetXY(5,$this->GetY()+5);
		$this->cell(40,5,'NOM',1,0,'L',1,0);
		$this->cell(40,5,'PRENOM',1,0,'L',1,0);
		$this->cell(20,5,'SEXE',1,0,'L',1,0);
		$this->cell(59,5,'ADRESSE',1,0,'L',1,0);$this->cell(20,5,'DATE',1,0,'L',1,0);
		$this->cell(7,5,'B',1,0,'L',1,0);
		$this->cell(7,5,'C',1,0,'L',1,0);
		$this->cell(7,5,'T',1,0,'L',1,0);
		$query1 = "SELECT * from structure where  STRUCTURE $EPH  and COMMUNE=$row->IDCOM and ETAT=0 ORDER BY NOM"; 
		$res1=mysql_query($query1);
		$tot2=mysql_num_rows($res1);
		$this->SetXY(5,$this->GetY()+5); 
		if ($tot2 > 0) {
		 while($row1=mysql_fetch_object($res1))
			...
			$this->cell(7,5,$this->NBRVEHIABC('C',$row1->id,'0')+$this->NBRVEHIABC('B',$row1->id,'0'),1,0,'C',0);
	...
	function structure($EPH1)
	{	
	$this->SetFont( 'Arial', '', 10 );
	// $this->SetXY(5,25);$this->cell(290,5,html_entity_decode(utf8_decode($EPH1)),1,0,'C',1,0);
	$this->SetFont('Times', 'B', 10);
	$h=35;
	$this->SetXY(5,$h);
	$this->cell(10,5,"idcom",1,0,'C',1,0);
	$this->cell(30,5,"Commune",1,0,'C',1,0);
	$this->cell(11,5,"EPH",1,0,'C',1,0);
	$this->cell(11,5,"EH",1,0,'C',1,0);
	$this->cell(11,5,"EHS",1,0,'C',1,0);
	$this->cell(11,5,"EPSP",1,0,'C',1,0);
	$this->cell(11,5,"POLY",1,0,'C',1,0);
	$this->cell(11,5,"SS",1,0,'C',1,0);
	$this->cell(11,5,"EHP",1,0,'C',1,0);
	$this->cell(11,5,"HEM",1,0,'C',1,0);
	$this->cell(11,5,"DIA",1,0,'C',1,0);
	$this->cell(11,5,"PHA",1,0,'C',1,0);
	$this->cell(11,5,"LAB",1,0,'C',1,0);
	$this->cell(11,5,"DES",1,0,'C',1,0);
	$this->cell(11,5,"DEG",1,0,'C',1,0);
	$this->cell(11,5,"MES",1,0,'C',1,0);
	$this->cell(11,5,"MEG",1,0,'C',1,0);
	$this->cell(11,5,"SF",1,0,'C',1,0);
	$this->cell(11,5,"PSY",1,0,'C',1,0);
	$this->cell(11,5,"SON",1,0,'C',1,0);
	$this->cell(11,5,"TRP",1,0,'C',1,0);
	$this->cell(11,5,"UDS",1,0,'C',1,0);
	$this->cell(11,5,"OPT",1,0,'C',1,0);
	$this->cell(18,5,"TOT",1,0,'C',1,0);
	$this->SetXY(5,$h+5);
	$IDWIL=17000;
	$ANNEE='2007';
			$this->mysqlconnect();
			...
			while($row=mysql_fetch_object($resultat))
			{
				...
				$this->cell(10,4,trim($row->IDCOM),1,0,'C',0);
				$this->cell(30,4,trim($row->COMMUNE),1,0,'L',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=3'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=4'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=5'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=6'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=7'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=8'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=9'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=10'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=11'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=12'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=13'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=14'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=15'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=16'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=17'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=18'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=19'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=20'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=21'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=22'),1,0,'C',0);
				$this->cell(11,4,$this->strucomm(trim($row->IDCOM),'=23'),1,0,'C',0);
				$this->cell(18,4,$this->strucomm(trim($row->IDCOM),'IS NOT NULL'),1,0,'C',0);
	...
	$this->cell(11,5,$this->strucomm1('=6'),1,0,'C',1,0);//21
	$this->cell(11,5,$this->strucomm1('=7'),1,0,'C',1,0);//21
	$this->cell(11,5,$this->strucomm1('=8'),1,0,'C',1,0);//21
	$this->cell(11,5,$this->strucomm1('=9'),1,0,'C',1,0);//21
	$this->cell(11,5,$this->strucomm1('=10'),1,0,'C',1,0);//21
	$this->cell(11,5,$this->strucomm1('=11'),1,0,'C',1,0);//21
	$this->cell(11,5,$this->strucomm1('=12'),1,0,'C',1,0);//21
	$this->cell(11,5,$this->strucomm1('=13'),1,0,'C',1,0);//21
	$this->cell(11,5,$this->strucomm1('=14'),1,0,'C',1,0);//21
	$this->cell(11,5,$this->strucomm1('=15'),1,0,'C',1,0);//21
	$this->cell(11,5,$this->strucomm1('=16'),1,0,'C',1,0);//21
	$this->cell(11,5,$this->strucomm1('=17'),1,0,'C',1,0);//21
	$this->cell(11,5,$this->strucomm1('=18'),1,0,'C',1,0);//21
	$this->cell(11,5,$this->strucomm1('=19'),1,0,'C',1,0);//21
	$this->cell(11,5,$this->strucomm1('=20'),1,0,'C',1,0);//21
	$this->cell(11,5,$this->strucomm1('=21'),1,0,'C',1,0);//21
	$this->cell(11,5,$this->strucomm1('=22'),1,0,'C',1,0);//21
	$this->cell(11,5,$this->strucomm1('=23'),1,0,'C',1,0);//21
	$this->cell(18,5,$this->strucomm1('IS NOT NULL'),1,0,'C',1,0);//21
		
	}
	
	
	function mesureprise($mesureprise)
	{
	if ($mesureprise=='0') $result="Aucune";
	if ($mesureprise=='1') $result="Convocation"; 
	if ($mesureprise=='2') $result="Questionnaire";
	if ($mesureprise=='3') $result="Mise en Demeure";
	if ($mesureprise=='4') $result="Rappel à l'ordre";
    return $result;
	}
	function repartanomx($datejour1,$datejour2,$EPH)
	{
	$h=35;
	$this->SetFont( 'Arial', '', 10 );
	...
	$this->mysqlconnect();
	mysql_query("SET NAMES 'UTF8' ");
	$query = "SELECT DATE,ids,REF,PJ,MP FROM insp where (DATE BETWEEN '$datejour1' AND '$datejour2') and STRUCTURE $EPH ORDER BY DATE";// where ids=$ids    where date betwen  
	$resultat=mysql_query($query);
	$totalmbr1=mysql_num_rows($resultat);
	while($row=mysql_fetch_object($resultat))
	{
		...
		$this->SetFillColor(240, 248, 255);//0 250 154
		$this->cell(40,(5*$totalmbr11)+10,$this->dateUS2FR($row->DATE),1,0,'C',1,0);
		$this->SetFillColor(0 ,250, 154);
		$this->cell(50,5,$this->nbrtostring('structure','id',$row->ids,'NOM').'_'.$this->nbrtostring('structure','id',$row->ids,'PRENOM'),1,0,1,'L',0);
		...
		$this->SetXY(45,$this->GetY());$this->cell(246,05,"total : ".$totalmbr11." anomalie(s)",1,1,1,'C',0);
		$this->SetXY(5,$this->GetY()+5); 
		$query2 = "SELECT * FROM inspection where (DATE BETWEEN '$datejour1' AND '$datejour2') and STRUCTURE $EPH ";
	...
	function NBRANNOMALIE($IDS,$ETAT) 
	{
	$this->mysqlconnect();
	$requete="SELECT * FROM inspection where ids ='$IDS' and  ETAT=$ETAT  ";
	$requete = @mysql_query($requete) or die($requete."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	...
	function NBRVEHIABC($Categorie,$idt,$ETAT) 
	{
	$this->mysqlconnect();
	$requete="SELECT * FROM auto where Categorie ='$Categorie' AND idt='$idt' and ETAT=$ETAT  ";
	$requete = @mysql_query($requete) or die($requete."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	...
	function NBRVEHIABCPC($Categorie,$COMMUNE,$ETAT) 
	{
	$this->mysqlconnect();
	$requete="SELECT * FROM auto where Categorie ='$Categorie'  and COMMUNE	= $COMMUNE  and  ETAT=$ETAT  ";
	$requete = @mysql_query($requete) or die($requete."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	...
	function NBRVEHIABCPW($Categorie,$ETAT) 
	{
	$this->mysqlconnect();
	$requete="SELECT * FROM auto where Categorie ='$Categorie' and  ETAT=$ETAT  ";
	$requete = @mysql_query($requete) or die($requete."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	...
	{
	$this->mysqlconnect();
	$sql = " select * from $TBL where  ($COLONE2='$VALEUR2') and (STRUCTURE $STRUCTURED) and ETAT='0'";
	...
	{
	$this->mysqlconnect();
	$sql = " select * from $TBL where  (STRUCTURE $STRUCTURED) and ETAT='0'  ";
	$requete = @mysql_query($sql) or die($sql."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	}	
	function strucomm($COMMUNER,$STRUCTURE) 
	{
	$this->mysqlconnect();
	$sql = " select * from structure where COMMUNE=$COMMUNER and STRUCTURE $STRUCTURE and ETAT=0";
	$requete = @mysql_query($sql) or die($sql."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	if ($OP==0) 
    ...
    function strucomm1($STRUCTURE) 
	{
	$this->mysqlconnect();
	$sql = " select * from structure where STRUCTURE $STRUCTURE and ETAT=0";
	$requete = @mysql_query($sql) or die($sql."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	if ($OP==0) 
	...
	{    
		...
		while($row=mysql_fetch_object($resultat))
		{
			...
			$this->cell(20,4,$this->valeurmoisdeces('','structure','DATE','COMMUNE',$datejour1,$datejour2,trim($row->IDCOM),'',$STRUCTURED),1,0,'L',0);
			$this->cell(20,4,round(($this->valeurmoisdeces('','structure','DATE','COMMUNE',$datejour1,$datejour2,trim($row->IDCOM),'',$STRUCTURED)*1000)/$row->POPULATION,3),1,0,'L',0);
		...
		$this->cell(20,5,round(($this->valeurmoisdecest('','structure','DATE','COMMUNE',$datejour1,$datejour2,'','',$STRUCTURED)*1000)/round($rs1['total1'],3),3),1,0,'C',1,0);	  
	}
	function mdocomm($DATEJOUR1,$DATEJOUR2,$COMMUNER,$STRUCTURED,$MDO) 
	{
	$this->mysqlconnect();
	$sql = " select * from structure where COMMUNE=$COMMUNER and STRUCTURE $STRUCTURED ";//DATEMDO BETWEEN '$DATEJOUR1' AND '$DATEJOUR2' and  and MDO=$MDO
	$requete = @mysql_query($sql) or die($sql."<br>".mysql_error());
	$OP=mysql_num_rows($requete);
	mysql_free_result($requete);
	return $OP;
	...
	{
	$data = array(
	"titre"=> 'Repartition / Tranche' ,//'Nombre De '.ucwords(strtolower($this->nbrtostring('mdo','id',$MDO,'mdo')))
	"A"    => '00 - 00',
	"B"    => '01 - 10',
	"C"    => '11 - 20',
	"D"    => '21 - 40',
	...
	if($x >10 and $x<=20){$this->SetDrawColor(255,0,0);$this->SetFillColor(0,255,0);}//orange
	if($x >21 and $x<=40){$this->SetDrawColor(255,0,0);$this->SetFillColor(255,0,0);}//rouge
	if($x >40 and $x<=1000){$this->SetDrawColor(255,0,0);$this->SetFillColor(165,42,42);}//brond	
    }
	...
	$this->RoundedRect($x-15,35,140,195, 2, $style = '');
	...
	$this->RoundedRect($x-10,155,35,55, 2, $style = '');
	$this->color(0);    $this->SetXY($x-10,150);$this->cell(30,5,$data['titre'],0,0,'L',0,0);
	$this->color(0);    $this->SetXY($x-5,$this->GetY()+10);$this->cell(15,5,'',1,0,'C',1,0);$this->cell(15,5,$data['A'],0,0,'L',0,0);
	$this->color(1);    $this->SetXY($x-5,$this->GetY()+10);$this->cell(15,5,'',1,0,'C',1,0);$this->cell(15,5,$data['B'],0,0,'L',0,0);
	$this->color(11);   $this->SetXY($x-5,$this->GetY()+10);$this->cell(15,5,'',1,0,'C',1,0);$this->cell(15,5,$data['C'],0,0,'L',0,0);
	$this->color(40);   $this->SetXY($x-5,$this->GetY()+10);$this->cell(15,5,'',1,0,'C',1,0);$this->cell(15,5,$data['D'],0,0,'L',0,0);
	$this->color(100);  $this->SetXY($x-5,$this->GetY()+10);$this->cell(15,5,'',1,0,'C',1,0);$this->cell(15,5,$data['E'],0,0,'L',0,0);
	$this->color(0);    $this->SetXY($x+40,$this->GetY()+10);$this->cell(40,5,'00km_____45km_____90km',0,0,'L',0,0);
	$this->color(0);    $this->SetXY($x+40,$this->GetY()+10);$this->cell(40,5,'Source : DR TIBA ',0,0,'L',0,0);
	$this->color(0);
