...
echo '</br>';
 ...
 $sql=mysql_query("SELECT * FROM specialiste order by NOM  asc");
echo "<table  width='90%' border='1' cellpadding='5' cellspacing='1' align='center'>" ;
 ...
 while($value=mysql_fetch_array($sql))
	...
	echo '<td>';echo $value['SPECIALITE'];echo '</td>';// 
	
	$sql1 = "INSERT INTO structure (STRUCTURE,NATURE,NOM,PRENOM,SEX,WILAYA,COMMUNE,ADRESSE,SPECIALITE) 
	
	VALUES ('".$value['STRUCTURE']."','".$value['NATURE']."','".$value['NOM']."','".$value['PRENOM']."','".$value['SEX']."','".$value['WILAYA']."','".$value['COMMUNE']."','".$value['ADRESSE']."','".$value['SPECIALITE']."');";
