...
//*************************************************************************************************************************//
$pdf->entetedecision("مقررة ترخيص فتح قاعة شبه طبية لفحص النساء الحوامل",$DATEP);
//*************************************************************************************************************************//
...
$pdf->demande_pm($NUMD,$DATED,"بفتح","لفحص النساء الحوامل",1,$adressen,$communen);
$pdf->conformite_pm($DATEP);
//*************************************************************************************************************************//
$pdf->propositiondecision();
//*************************************************************************************************************************//
$pdf->decision_a_o_pm($nomar,$prenomar,$adressen,$communen,' قابلة ');
