...
if ($STRUCTURE==12) {$pdf->SetXY(16,$pdf->GetY()+8);$pdf->Cell(100,5,"السيد مدير جامعة ".$UNIV,0,0,'C',0,1);} 
if ($STRUCTURE==13) {$pdf->SetXY(16,$pdf->GetY()+8);$pdf->Cell(100,5,"السيد مدير جامعة ".$UNIV,0,0,'C',0,1);} 
if ($STRUCTURE==14) {$pdf->SetXY(16,$pdf->GetY()+8);$pdf->Cell(100,5,"السيد مدير جامعة ".$UNIV,0,0,'C',0,1);} 
if ($STRUCTURE==15) {$pdf->SetXY(16,$pdf->GetY()+8);$pdf->Cell(100,5,"السيد مدير جامعة ".$UNIV,0,0,'C',0,1);} 
if ($STRUCTURE==16) {$pdf->SetXY(16,$pdf->GetY()+8);$pdf->Cell(100,5,"السيد مدير جامعة ".$UNIV,0,0,'C',0,1);} 
if ($STRUCTURE==17) {$pdf->SetXY(16,$pdf->GetY()+8);$pdf->Cell(100,5,"السيد مدير جامعة ".$UNIV,0,0,'C',0,1);} 
if ($STRUCTURE==19) {$pdf->SetXY(16,$pdf->GetY()+8);$pdf->Cell(100,5,"السيد مدير جامعة ".$UNIV,0,0,'C',0,1);} 
if ($STRUCTURE==23) {$pdf->SetXY(16,$pdf->GetY()+8);$pdf->Cell(100,5,"السيد مدير المعهد التكوين الشبه الطبي ".$UNIV,0,0,'C',0,1);} 
if ($STRUCTURE==24) {$pdf->SetXY(16,$pdf->GetY()+8);$pdf->Cell(100,5,"السيد مدير المعهد التكوين الشبه الطبي ".$UNIV,0,0,'C',0,1);} 
if ($STRUCTURE==25) {$pdf->SetXY(16,$pdf->GetY()+8);$pdf->Cell(100,5,"السيد مدير المعهد التكوين الشبه الطبي ".$UNIV,0,0,'C',0,1);} 

$pdf->SetXY(80,$pdf->GetY()+10);$pdf->Cell(120,5," الموضوع : طلب توثيق شهادة",0,0,'R',0,1);
$pdf->SetFont('aefurat', '', 14);
$pdf->SetXY(80,$pdf->GetY()+10);$pdf->Cell(120,5," المرفقات :  ".""."نسخة من الشهادة.",0,0,'R',0,1);
