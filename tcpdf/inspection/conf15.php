...
{
	$pdf->entetepvc("D'UN CABINET DE CHIRURGIE DENTAIRE","Note N°664/MSP/DSS/SDCC du 01/12/1997 ");
	...
	while($rowy=mysql_fetch_object($requetey))
	{
		...
		if($rowy->NAT==1){$pdf->Cell(200,5,"Dans un Cadre de Transfert d'un cabinet de chirurgie dentaire",0,1,'L');}
		if($rowy->NAT==2){$pdf->Cell(200,5,"Dans un Cadre d'une Instatllation d'un cabinet de chirurgie dentaire ",0,1,'L');"";}
		if($rowy->NAT==3){$pdf->Cell(200,5,"Dans un Cadre d'une Ouverture d'un cabinet de chirurgie dentaire ",0,1,'L');"";}
	...
	$pdf->SetXY(20,$pdf->GetY()+5);$pdf->Cell(200,5,"J'atteste que le cabinet de chirurgie dentaire de Mr/Melle/Mme : ".strtoupper($rowx->NOM).'_'.strtolower ($rowx->PRENOM),0,1,'L');
