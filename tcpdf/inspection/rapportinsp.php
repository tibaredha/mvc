...
{
$pdf->SetXY(10,$pdf->GetY()+5);$pdf->Cell(100,5,'OBJET : A/S inspection du local de MR '.$pdf->nbrtostring('mvc','structure','id',$rowy->ids,'NOM')."_".$pdf->nbrtostring('mvc','structure','id',$rowy->ids,'PRENOM'),0,1,'L');
$pdf->SetXY(10,$pdf->GetY());$pdf->Cell(100,5,'REF : '.$rowy->REF,0,1,'L');
$pdf->SetXY(10,$pdf->GetY());$pdf->Cell(100,5,'PJ : '.$rowy->PJ,0,1,'L');
$pdf->SetXY(30,$pdf->GetY()+5);$pdf->Cell(100,5,"Suite à l'inspection effectuée  le  ".$pdf->dateUS2FR($rowy->DATE)."  au niveau  du local de Mr ".$pdf->nbrtostring('mvc','structure','id',$id1,'NOM')."_".$pdf->nbrtostring('mvc','structure','id',$id1,'PRENOM'),0,1,'L');
$pdf->SetXY(20,$pdf->GetY());$pdf->Cell(100,5,$pdf->nbrtostring('mvc','structurebis','id',$pdf->nbrtostring('mvc','structure','id',$rowy->ids,'STRUCTURE'),'structure'),0,1,'L');
$pdf->SetXY(20,$pdf->GetY());$pdf->Cell(100,5,"Commune de ".$pdf->nbrtostring('mvc','com','IDCOM',$pdf->nbrtostring('mvc','structure','id',$rowy->ids,'COMMUNE'),'COMMUNE').' Wilaya de Djelfa ',0,1,'L');
$pdf->SetXY(20,$pdf->GetY());$pdf->Cell(100,5,'On a constaté ce qui suit :',0,1,'L');
}
...
$pdf->SetXY(20,$pdf->GetY());$pdf->Cell(100,5,'Conclusion',0,1,'L');
$pdf->SetXY(30,$pdf->GetY()+2);$pdf->Cell(100,5,'respect de la réglementation en vigueur.',0,1,'L');
} else {
$pdf->SetXY(20,$pdf->GetY());$pdf->Cell(100,5,'Conclusion',0,1,'L');
$pdf->SetXY(30,$pdf->GetY()+2);$pdf->Cell(100,5,'Non respect de la réglementation en vigueur.',0,1,'L');
}
