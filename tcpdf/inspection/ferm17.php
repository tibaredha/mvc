...
$pdf->decision_o($num1,$date1,"عامة",$nomar,$prenomar);
$pdf->demande($NUMD,$DATED,"بغلق","العامة",1,$adressen,$communen);
//*************************************************************************************************************************//
$pdf->propositiondecision();
//*************************************************************************************************************************//
$pdf->decision_a_f($pdf->article_1,$nomar,$prenomar,$adressen,$communen);
