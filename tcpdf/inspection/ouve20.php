...
//*************************************************************************************************************************//
$pdf->entetedecision("مقررة ترخيص بفتح قاعة علاج",$DATEP);
//*************************************************************************************************************************//
...
//$pdf->u_diplome ($pdf->diplome20,$DIPLOME,$UNIV,$nomar,$prenomar);
//$pdf->c_order($pdf->ordre17,$NUMORDER,$DATEORDER);
//$pdf->demande($NUMD,$DATED,"بفتح","قاعة علاج",1,$adressen,$communen);
