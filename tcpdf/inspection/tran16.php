...
//*************************************************************************************************************************//
$pdf->entetedecisions("بتحويل عيادة طبية متخصصة ",$DATEP,$SPECIALITE);
//*************************************************************************************************************************//
...
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,' بتحويل عيادته (ها) الطبية المتخصصة الكائن مقرها ' .' ب '.$adresse.' بلدية '.$commune.' ولاية الجلفة',0,1,'R');
