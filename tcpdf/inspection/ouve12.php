...
$pdf->SetTitle('ouverture_pharmacien');
...
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,$pdf->arrete002_2005,0,1,'R');

//$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,$pdf->arrete110_96,0,1,'R');

$pdf->SetFont('aefurat', '', 12.5);
