...
while($rowx=mysql_fetch_object($requetex))
{
	...
	if ($NAT==1){
	$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(10,5,"",1,0,'C');$pdf->Cell(190,5,"DEMANDE D'INSTALLATION EN CABINET SPECIALISE DE : ",0,1,'L');
	...
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"",1,0,'C');$pdf->Cell(190,5,"DEMANDE DE FERMETURE DE CABINET SPECIALISE DE : ",0,1,'L');	
	}
	if ($NAT==2){
	...
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"",1,0,'C');$pdf->Cell(190,5,"DEMANDE DE TRANSFER DE CABINET SPECIALISE DE : ",0,1,'L');
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"",1,0,'C');$pdf->Cell(190,5,"DEMANDE DE FERMETURE DE CABINET SPECIALISE DE : ",0,1,'L');	
	}
	if ($NAT==3){
	$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(10,5,"X",1,0,'C');$pdf->Cell(190,5,"DEMANDE D'INSTALLATION EN CABINET SPECIALISE DE : ".$pdf->nbrtostring('mvc','specialite','idspecialite',$rowx->SPECIALITEX,'specialitefr'),0,1,'L');
	...
	$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(10,5,"",0,0,'L');  $pdf->Cell(55,5,"M'INSTALLER",0,0,'C');               $pdf->Cell(130,5,"DANS LA COMMUNE : ".$commune,0,0,'L');   
	...
	$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(10,5,"X",1,0,'C');  $pdf->Cell(55,5,"DE MON CABINET POUR",0,0,'C');       $pdf->Cell(130,5,"DANS LA DAIRA DE : *** ",0,0,'L'); 
	$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(10,5,"",0,0,'L');  $pdf->Cell(55,5,"POUR LES RAISONS SUIVANTES",0,0,'C'); $pdf->Cell(130,5,"DANS LA COMMUNE :".$commune,0,0,'L');   
	$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(10,5,"",0,0,'L');  $pdf->Cell(55,5,".........................................",0,0,'C');
	}
	...
	$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(100,5,$pdf->dateUS2FR($DATED),0,0,'C');$pdf->Cell(95,5,"",0,0,'C');
	...
	$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(100,5,"NUMERO DE LA DEMANDE : ".$NUMD,0,0,'L'); 
	...
	$pdf->SetFont('aefurat', '', 10);
	$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,"EXERCICE A TITRE LIBERAL DES PRATICIENS SPECIALISTES",1,1,'C');
	$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,"FORMULAIRE (B) : A REMPLIR PAR LE DIRECTEUR DE LA SANTE ET DE LA POPULATION",0,1,'L');
	
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(200,5,"WILAYA : DJELFA ",0,1,'L');
	
	
	if ($NAT==1){
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"",1,0,'C');$pdf->Cell(190,5,"DEMANDE D'INSTALLATION : ",0,1,'L');
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"X",1,0,'C');$pdf->Cell(190,5,"DEMANDE DE TRANSFER : ".$commune,0,1,'L');
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"",1,0,'C');$pdf->Cell(190,5,"DEMANDE DE FERMETURE : ",0,1,'L');
	}
	if ($NAT==2){
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"X",1,0,'C');$pdf->Cell(190,5,"DEMANDE D'INSTALLATION : ".$commune,0,1,'L');
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"",1,0,'C');$pdf->Cell(190,5,"DEMANDE DE TRANSFER : ",0,1,'L');
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"",1,0,'C');$pdf->Cell(190,5,"DEMANDE DE FERMETURE : ",0,1,'L');
	}
	if ($NAT==3){
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"X",1,0,'C');$pdf->Cell(190,5,"DEMANDE D'INSTALLATION : ".$commune,0,1,'L');
	...
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"",1,0,'C');$pdf->Cell(190,5,"DEMANDE D'INSTALLATION : ",0,1,'L');
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"",1,0,'C');$pdf->Cell(190,5,"DEMANDE DE TRANSFER : ",0,1,'L');
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"X",1,0,'C');$pdf->Cell(190,5,"DEMANDE DE FERMETURE : ".$commune,0,1,'L');
	}
	
	
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(200,5,"DEPOSEE PAR Dr :  ".$rowx->NOM.' '.$rowx->PRENOM,0,1,'L');
    $pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(200,5,"MEDECIN SPECIALISTE EN :  ".$pdf->nbrtostring('mvc','specialite','idspecialite',$rowx->SPECIALITEX,'specialitefr'),0,1,'L');
    $pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(200,5,"---------------------------------------------------------------------------------------------------------------------------------------------------------------------",0,0,'L');
	$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,"LOCALITE DEMANDEE POUR L'INSTALATION : ",0,1,'L');
	
	$pdf->SetXY(15,$pdf->GetY()+5);$pdf->Cell(56,5,"",1,0,'L',0,0);       $pdf->Cell(66,5,"DE",1,0,'C',0,0);$pdf->Cell(56,5,"NOMBRE D'HABITANTS",1,0,'C',0,0);
	$pdf->SetXY(15,$pdf->GetY()+5);$pdf->Cell(56,5,"WILAYA",1,0,'L',0,0); $pdf->Cell(66,5,"Djelfa",1,0,'C',0,0);  $pdf->Cell(56,5,"",1,0,'C',0,0);
	$pdf->SetXY(15,$pdf->GetY()+5);$pdf->Cell(56,5,"DAIRA",1,0,'L',0,0);  $pdf->Cell(66,5,"***",1,0,'C',0,0);  $pdf->Cell(56,5,"***",1,0,'C',0,0);
	$pdf->SetXY(15,$pdf->GetY()+5);$pdf->Cell(56,5,"COMMUNE",1,0,'L',0,0);$pdf->Cell(66,5,$commune,1,0,'C',0,0);  $pdf->Cell(56,5,"",1,0,'C',0,0);
	
	$pdf->SetXY(15,$pdf->GetY()+10);$pdf->Cell(56,5,"NOMBRE DE SPECIALISTE DE",1,0,'L',0,0);$pdf->Cell(42,5,"DE TOUTE LA WILAYA",1,0,'C',0,0);$pdf->Cell(40,5,"DAIRA DE ",1,0,'C',0,0);$pdf->Cell(40,5,"COMMUNE DE",1,0,'C',0,0);
	$pdf->SetXY(15,$pdf->GetY()+5);$pdf->Cell(56,5,"DE LA MEME SPECIALITE",1,0,'L',0,0);    $pdf->Cell(42,5,"Djelfa",1,0,'C',0,0);$pdf->Cell(40,5,"***",1,0,'C',0,0);$pdf->Cell(40,5,$commune,1,0,'C',0,0);
	$pdf->SetXY(15,$pdf->GetY()+5);$pdf->Cell(56,5,"EN EXERCICE LIBERAL",1,0,'L',0,0);      $pdf->Cell(42,5,"",1,0,'C',0,0);$pdf->Cell(40,5,"***",1,0,'C',0,0);$pdf->Cell(40,5,"",1,0,'C',0,0);
	
	$pdf->SetXY(15,$pdf->GetY()+10);$pdf->Cell(56,5,"NOMBRE DE SPECIALISTE DE",1,0,'L',0,0);$pdf->Cell(42,5,"DE TOUTE LA WILAYA",1,0,'C',0,0);$pdf->Cell(40,5,"DAIRA DE ",1,0,'C',0,0);$pdf->Cell(40,5,"COMMUNE DE",1,0,'C',0,0);
	$pdf->SetXY(15,$pdf->GetY()+5);$pdf->Cell(56,5,"DE LA MEME SPECIALITE",1,0,'L',0,0);    $pdf->Cell(42,5,"Djelfa",1,0,'C',0,0);$pdf->Cell(40,5,"***",1,0,'C',0,0);$pdf->Cell(40,5,$commune,1,0,'C',0,0);
	$pdf->SetXY(15,$pdf->GetY()+5);$pdf->Cell(56,5,"EN EXERCICE PUBLICS",1,0,'L',0,0);      $pdf->Cell(42,5,"",1,0,'C',0,0);$pdf->Cell(40,5,"***",1,0,'C',0,0);$pdf->Cell(40,5,"",1,0,'C',0,0);
	
	$pdf->SetXY(5,$pdf->GetY()+10);$pdf->Cell(200,5,"AVIS DU DIRECTEUR DE LA SANTE ET DE LA POPULATION : ",0,1,'L');
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"",1,0,'C');$pdf->Cell(190,5,"FAVORABLE POUR LA LOCALITE DEMANDEE (*)",0,1,'L');
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"",0,0,'C');$pdf->Cell(190,5,"(donner les raisons) : -----------------------------------------------------------------------------------------------------------------------------",0,1,'L');
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"",0,0,'C');$pdf->Cell(190,5,"-------------------------------------------------------------------------------------------------------------------------------------------------------",0,1,'L');
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"",0,0,'C');$pdf->Cell(190,5,"-------------------------------------------------------------------------------------------------------------------------------------------------------",0,1,'L');
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"",1,0,'C');$pdf->Cell(190,5,"FAVORABLE POUR LES LOCALITES SUTVANTËS DANS LA MEME WILAYA",0,1,'L');
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"",0,0,'C');$pdf->Cell(190,5,"(donner les raisons) : -----------------------------------------------------------------------------------------------------------------------------",0,1,'L');
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"",0,0,'C');$pdf->Cell(190,5,"-------------------------------------------------------------------------------------------------------------------------------------------------------",0,1,'L');
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(10,5,"",0,0,'C');$pdf->Cell(190,5,"-------------------------------------------------------------------------------------------------------------------------------------------------------",0,1,'L');
	$pdf->SetXY(5,$pdf->GetY()+2);$pdf->Cell(200,5,"---------------------------------------------------------------------------------------------------------------------------------------------------------------------",0,0,'L');
	
	$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(100,5,"DATE DE LA DEMANDE : ",0,0,'C');$pdf->Cell(100,5,"SIGNATURE ET CACHET DU DSP : ",0,0,'C');
	$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(100,5,$pdf->dateUS2FR($DATED),0,0,'C'); $pdf->Cell(100,5,"--------------------",0,0,'C');
	$pdf->SetXY(5,$pdf->GetY()+20);$pdf->Cell(200,5,"---------------------------------------------------------------------------------------------------------------------------------------------------------------------",0,0,'L');
	$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(100,5,"Le numéro de la demande de l'intéressé:",0,0,'C');$pdf->Cell(100,5,$NUMD,0,0,'C');
}
$pdf->dossier($DATEP);
$pdf->AddPage();$pdf->SetFont('aefurat', '', 12);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,$pdf->repar,0,1,'C');$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,$pdf->repfr,0,1,'C');
