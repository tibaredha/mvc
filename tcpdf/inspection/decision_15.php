...
$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,'- بناء على شهلدة التسجيل بمجلس اخلاقيات المهنة لجراحة الاسنان  رقم '.$_POST["NUMORDER"].' بتاريخ '.$pdf->dateUS2FR($_POST["DATEO"]).' للمعنى (ة)  ',0,1,'R');
...
$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,'- بناء على طلب السيد (ة) '.$nomar.' '.$prenomar.' جراح اسنان بتاريخ '.$pdf->dateUS2FR($_POST["DATEDEM"]).' المتعلق بفتح  عيادة طبية في جراحة الاسنان ',0,1,'R');$pdf->SetFont('aefurat', '', 13);
