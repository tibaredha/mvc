...
$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,'- بناء على مقرر الاستقالة رقم '.$_POST["NUMDÉMISSION"].' المؤرخ في '.$pdf->dateUS2FR($_POST["DATEDÉMISSION"]).' الصادر عن '.$_POST["ETA"],0,1,'R');
