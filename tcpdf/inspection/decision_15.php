...
$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,'مقررة تتضمن فتح  عيادة طبية لجراحـــــة الاسنان',0,1,'C');$pdf->SetFont('aefurat', '', 16);
...
$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,'- بناء على شهادة النجاح في جراحة الاسنان  بتاريخ '.' 0000/00/00 '.' الصادرة عن جامعة '.'********',0,1,'R');$pdf->SetFont('aefurat', '', 12);
...
$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,'- بناء على طلب السيد (ة) '.$nomar.' '.$prenomar.' جراح اسنان بتاريخ '.' __ __ ____ '.' المتعلق بفتح  عيادة طبية في جراحة الاسنان ',0,1,'R');$pdf->SetFont('aefurat', '', 13);
$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,'  ب '.$adresse.'  ببلدية  '.$commune.' ولاية الجلفة',0,1,'R');
$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,'- بناء على شهلدة التسجيل بمجلس اخلاقيات المهنة لجراحة الاسنان  رقم '.' 000 '.' بتاريخ '.' 0000/00/00 '.' للمعنى ',0,1,'R');
...
$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,'المادة الأولى : يرخص للسيد(ة)  '.$nomar.' '.$prenomar.' جراح اسنان '.' بفتح عيادته (ها) الطبية لجراحة الاسنان الكائن مقرها ',0,1,'R');
