...
//*************************************************************************************************************************//
$pdf->entetedecision("مقررة ترخيص بتحويل عيادة طبية لطب الاسنان",$DATEP);
//*************************************************************************************************************************//
...
$pdf->decision_o($num1,$date1,"لطب الاسنان ",$nomar,$prenomar);
$pdf->demande($NUMD,$DATED,"بتحويل","لطب  الاسنان ",0,$adressen,$communen);
$pdf->conformite($DATEP);
//*************************************************************************************************************************//
$pdf->propositiondecision();
//*************************************************************************************************************************//
$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,$pdf->article1.$nomar.' '.$prenomar.' طبيب (ة) اسنان'.' بتحويل عيادته (ها) الطبية لطب الاسنان',0,1,'R');
