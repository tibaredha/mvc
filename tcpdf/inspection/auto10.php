...
while($rowp=mysql_fetch_object($requetep))
{
	...
	$etablissement0=' مركز خاص  لتصفية الدم ';
	...
	if (trim($nom) =='BEN SALEM'){$clinique=$eta2;}
	if (trim($nom) =='benmessoud'){$clinique=$eta3;}
	...
	$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,"- بمقتضى القرار الوزاري رقم 07 المؤرخ في 25 فيفري 1995 المحدد للمقاييس التقنية و الصحية وكذا ",0,1,'R');
	$pdf->SetXY(0,$pdf->GetY()+$y);$pdf->Cell(200,5," شروط تسيير مراكز تصفية الدم المعدل و المتمم بالقرار الوزاري المؤرخ في  22 نوفمبر 2005 ",0,1,'R');
