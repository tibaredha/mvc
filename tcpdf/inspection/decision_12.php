...
$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,'- بناء على طلب السيد (ة) '.$nomar.' '.$prenomar.' صيدلي بتاريخ '.$pdf->dateUS2FR($_POST["DATEDEM"]).' المتعلق بفتح صيدلية ببلدية '.$commune,0,1,'R');
