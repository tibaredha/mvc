...
$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,'مقــــرر فتح  صيدلــــــية',0,1,'C');$pdf->SetFont('aefurat', '', 16);
...
$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,'- بناء على طلب السيد (ة) '.$nomar.' '.$prenomar.' صيدلي (ة)  بتاريخ '.$pdf->dateUS2FR($_POST["DATEDEM"]).' المتعلق بفتح صيدلية ببلدية '.$commune,0,1,'R');
...
/*************************************************************************************************************************/
$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,$pdf->article1.$nomar.' '.$prenomar.' صيدلي (ة) '.' بفتح صيدليته (ها) الكائن مقرها ',0,1,'R');
