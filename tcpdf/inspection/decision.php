...
$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,'رقم : '.$num1.' /م. ص. س / '.substr($date1,0,4),0,1,'R');//$pdf->Cell(200,5,'رقم : ............./م. ص. س/ ',0,1,'R');
...
$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,'لمؤسسات النقل الصحي .',0,1,'R');
...
$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,'- بناءا على مقررة الإنجاز لوحدة النقل الصحي رقم  '.'_ _'.' المؤرخة في '.'__.__.____'.' الخاصة بالسيد(ة) '.$nomar.' '.$prenomar,0,1,'R');
...
$query_liste = "SELECT * FROM auto WHERE idt  ='$id' and ETAT='0' order by Categorie";//
...
$pdf->cell(40,6,$pdf->nbrcategorie('C',$id).' : C',1,0,'C',1,0);
$pdf->cell(40,6,$pdf->nbrcategorie('B',$id).' : B',1,0,'C',1,0);
$pdf->cell(40,6,$pdf->nbrcategorie('A',$id).' : A',1,0,'C',1,0);
...
$pdf->SetXY(15,$pdf->GetY()+6);
$query_listep = "SELECT * FROM pers WHERE idt  ='$id' and ETAT='0' order by Categorie";//
...
$pdf->cell(40,6,'  سائق : '.$pdf->nbrpers('C',$id),1,0,'C',1,0);
$pdf->cell(40,6,'  ممرض : '.$pdf->nbrpers('P',$id),1,0,'C',1,0);
