...
$pdf->SetXY(8,$pdf->GetY());$pdf->Cell(100,5,"مدير الصحة و السكان لولاية الجلفـــــــــة",0,0,'C',0,1);
...
if (isset($_POST['chkl']))
{
	...
	if ($_POST["Submitx" ]=="Submit")  
	{  
		for ($i=0; $i < sizeof ($checkbox1);$i++) 
		{  
			$query_liste = "SELECT * FROM auto WHERE idt  ='$ids' and ETAT='0' and id = '$checkbox1[$i]' order by Categorie";//
	...
	$pdf->cell(30,6,'المجموع : '.sizeof ($checkbox1),1,0,'C',1,0);
	$pdf->cell(150,6,'',1,0,'C',1,0);
}
else
{
