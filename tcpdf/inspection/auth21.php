...
$pdf->SetXY(8,$pdf->GetY()+5);$pdf->Cell(100,5,"الى",0,0,'C',0,1);
$pdf->SetXY(8,$pdf->GetY()+5);$pdf->Cell(100,5,"gg",0,0,'C',0,1);
$pdf->SetXY(80,$pdf->GetY()+10);$pdf->Cell(120,5," الموضوع : طلب التاكد من صحة البطاقات الرمادية ",0,0,'R',0,1);
...
$pdf->SetXY(1,$pdf->GetY()+5);$pdf->Cell(200,5,'يشرفني ان اطلب منكم التاكد من صحة البطاقات الرمادية المقدمة من طرف المعني حسب الجدول التالي : ',0,1,'R');
