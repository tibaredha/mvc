...
$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(100,5,"مدير الصحة و السكان لولاية الجلفـــــــــة",0,1,'C',1,1);
$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(100,5,"الى",0,1,'C',1,1);
$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(100,5,"gg",0,1,'C',1,1);
$pdf->SetXY(80,$pdf->GetY()+5);$pdf->Cell(120,5," الموضوع : طلب التاكد من صحة البطاقات الرمادية ",0,1,'C',1,1);
...
$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,'حتى يتسنى لنا منح اعتماد فتح و إستغلال وحدة للنقل الصحي '.' الخاص بالسيد(ة) '.$nomar.' '.$prenomar,0,1,'R');

$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,'يشرفني ان اطلب منكم التاكد من صحة البطاقات الرمادية المقدمة ',0,1,'R');
...
$pdf->SetLineWidth(0.4);
$pdf->Rect(5, 5, 200, 285 ,'D');$pdf->Rect(5-1, 5-1, 200+2, 285+2 ,'D');
$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,'تعين الوسائل المادية و البشرية  للسيد(ة) '.$nomar.' '.$prenomar.' كالتالي :',0,1,'R');
