...
$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,"=======================================================================",0,1,'c');
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,' المقرر رقم '.'_____'.' / م. ص. س / '.'المؤرخ في : '.'___________',0,1,'C');
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,'المتضمن الترخيص'.' بفتح '.'عيادة طبية متخصصة',0,1,'C');
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"=======================================================================",0,1,'c');

$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,$pdf->ledspar,0,1,'R');$pdf->SetFont('aefurat', '', 12);
