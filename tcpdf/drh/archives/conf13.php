...
$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,"PROCÉS VERBAL DE CONFORMITÉ D'UN LABORATOIRE D'ANALYSES MÉDICALES ",0,1,'C');$pdf->SetFont('aefurat', '', 12);
$pdf->SetFont('aefurat', '', 10);$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"REF : Arreté N°--/MSP/DSS/SDCC du 14/04/2008 ",0,1,'C');$pdf->SetFont('aefurat', '', 12);
...
if($rowy->NAT==1){$pdf->Cell(200,5,"Dans un Cadre de Transfert d'un laboratoire d'analyses médicales conformement a l'article 03  ",0,1,'L');}
if($rowy->NAT==2){$pdf->Cell(200,5,"Dans un Cadre d'une Instatllation d'un laboratoire d'analyses médicales conformement a l'article 03",0,1,'L');"";}
if($rowy->NAT==3){$pdf->Cell(200,5,"Dans un Cadre d'une Ouverture d'un laboratoire d'analyses médicales conformement a l'article 03 ",0,1,'L');"";}
$pdf->SetXY(20,$pdf->GetY()+5);$pdf->Cell(200,5,"Et compte tenu de l'état des lieux visités,à savoir : ",0,1,'L');


$pdf->SetXY(30,$pdf->GetY()+5); $pdf->Cell(200,5,"- salle d'accueil et de réception ",0,1,'L');       //$pdf->SetXY(115,$pdf->GetY()-5); $pdf->Cell(20,5,"Superficie  : ".$rowy->CDS0." M2",0,1,'L');
$pdf->SetXY(30,$pdf->GetY()+5); $pdf->Cell(200,5,"- bureau du praticien",0,1,'L');                                   //$pdf->SetXY(115,$pdf->GetY()-5); $pdf->Cell(20,5,"Superficie  : ".$rowy->CDS0." M2",0,1,'L');
$pdf->SetXY(30,$pdf->GetY()+5); $pdf->Cell(200,5,"- salle de prélèvement",0,1,'L');
$pdf->SetXY(30,$pdf->GetY()+5); $pdf->Cell(200,5,"- salle appareils physiques de précision",0,1,'L');
$pdf->SetXY(30,$pdf->GetY()+5); $pdf->Cell(200,5,"- Deux salles d'activités techniques de laboratoire",0,1,'L');
$pdf->SetXY(30,$pdf->GetY()+5); $pdf->Cell(200,5,"- salle de microbiologie et de parasitologie",0,1,'L');
