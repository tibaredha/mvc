...
$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,'مقررة تتضمن غلق وحدة للنقل الصحي ',0,1,'C');
...
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,'- بناءا على المقررة رقم '.$num.' المؤرخة في '.$date.' المتضمنة فتح وحدة نقل صحي '.' الخاصة بالسيد(ة) '.$nomar.' '.$prenomar,0,1,'R');
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,'- بناءا على الطلب الخاص بالسيد(ة) : '.$nomar.' '.$prenomar.' المؤرخ في '.$DATED.' المتضمن غلق وحدة النقل الصحي ',0,1,'R');//$num.
