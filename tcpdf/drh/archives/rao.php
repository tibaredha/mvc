...
$pdf->SetXY(10,$pdf->GetY()+5);$pdf->Cell(100,5,"OBJET :  Rappel à l'ordre ( avec accusé de réception )",0,1,'L');
...
$pdf->SetXY(20,$pdf->GetY());$pdf->Cell(100,5,"dans un délai de huit jours (08 jours) à compter de ce jour : ".$id2,0,1,'L');
$pdf->SetXY(20,$pdf->GetY());$pdf->Cell(100,5,"à 09:00 au siege de la Direction de la santé et de la population",0,1,'L');
