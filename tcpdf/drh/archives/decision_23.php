...
$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,'مقررة تتضمن فتح  محل لتركيب و بيع النظارات الطبية',0,1,'C');$pdf->SetFont('aefurat', '', 16);
...
$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,'- بناء على طلب السيد (ة) '.$nomar.' '.$prenomar.' بـصـاراتي نــظـاراتي بتاريخ '.' __ __ ____ '.' المتعلق بفتح  محل ',0,1,'R');$pdf->SetFont('aefurat', '', 13);
$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,' لتركيب وبيع النظارات الطبية'.'  ب '.$adresse.'  ببلدية  '.$commune.' ولاية الجلفة',0,1,'R');
...
$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,'المادة الأولى : يرخص للسيد(ة)  '.$nomar.' '.$prenomar.' بـصـاراتي نــظـاراتي'.' بفتح محله (ها) الكائن مقره ',0,1,'R');
$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,' ب '.$adresse.' بلدية '.$commune.' ولاية الجلفة',0,1,'R');
$pdf->SetXY(5,$pdf->GetY()+$y);$pdf->Cell(200,5,'المادة 02 : لايمكن تحويل اي مقر  للمحل دون استشارة مصالح مديرية الصحة و السكان',0,1,'R');//'المادة 02 : لايمكن تحويل اي مقر  للعيادة دون استشارة مصالح مديرية الصحة و السكان'
...
// 20 mars 2011
// Corps des opticiens lunetiers de santÈ publique
// Art. 109. ó Le corps des opticiens lunetiers de santÈ
// publique comprend cinq (5) grades :
// ó le grade díopticien lunetier brevetÈ, mis en voie
// díextinction
// ó le grade díopticien lunetier diplÙmÈ díEtat ;
// ó le grade díopticien lunetier de santÈ publique ;
// ó le grade díopticien lunetier spÈcialisÈ de santÈ
// publique ;
// ó le grade díopticien lunetier major de santÈ publique. 
