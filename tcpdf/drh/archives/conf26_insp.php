...
$pdf->SetXY(5,$pdf->GetY()+10);$pdf->Cell(200,5,"INSPECTION GENERALE",0,1,'C',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"INSPECTION DES ETABLISSEMENTS DE DISTRIBUTION EN GROS",0,1,'C',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"DE PRODUITS PHARMACEUTIQUES",0,1,'C',1,1);

$pdf->SetFont('aefurat', '', 14);

$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,10,"Praticiens Inspecteurs : Dr TIBA",0,1,'L',1,1);

$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,10,"Date de l'inspection : ".date('d-m-Y'),0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,10,"Etablissement Inspecté : ".$nom."".$prenom,0,1,'L',1,1);

$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,"Adressse Exacte  : ".$adresse,0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"Numeros de Telephone : ".$Mobile,0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"Numeros de Fax : ",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"Email : ",0,1,'L',1,1);

$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,"Enseigne presente : Oui/Non ",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"Texte porté sur l'enseigne : ",0,1,'L',1,1);

$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,"Agrement de l'exercice de l'activité de distribution en gros de produits pharmaceutiques : Oui/Non ",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"(Délivré par : DSP-Djelfa           sous le N° : ".$num1."             en Date du : ".$date1.")",0,1,'L',1,1);

$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,"Décision du pharmacien directeur technique  : Oui/Non ",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"(Délivré par : DSP-Djelfa           sous le N° :             en Date du :                 )",0,1,'L',1,1);

$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,"Le pharmacien directeur technique été présent lors de l'inspection : Oui/Non ",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"Est-il inscrit au tableau de l'ordre des pharmaciens : Oui/Non ",0,1,'L',1,1);

$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,"Activité exercée ",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"Distribution : Oui/Non ",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"Importation : Oui/Non ",0,1,'L',1,1);

$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,"L'établissement détient une liste des fournisseurs : Oui/Non ",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"* si non ,demander a ce quelle soit établie et communiquée ,signée et datée",0,1,'L',1,1);

$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,"L'établissement détient une liste des clients : Oui/Non ",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"* si non ,demander a ce quelle soit établie et communiquée ,signée et datée",0,1,'L',1,1);

$pdf->AddPage();

$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,"Le stock des produits pharmaceutiques existe-t-il : Oui/Non ",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"observation",0,1,'L',1,1);

$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,"Les factures d'achats sont elles archivées  : Oui/Non ",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"Elles comportent",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"- Date d'entrée : Oui/Non",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"- DCI du médicament : Oui/Non ",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"- Forme : Oui/Non",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"- Dosage : Oui/Non",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"- Quantité recus par N° de lot : Oui/Non",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"- la date de peremption : Oui/Non",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"- Nom et adresse du fournisseur  : Oui/Non",0,1,'L',1,1);


$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,"Les factures de ventes sont elles archivées  : Oui/Non ",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"Elles comportent",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"- Date de livraison : Oui/Non",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"- DCI du médicament : Oui/Non ",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"- Forme : Oui/Non",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"- Dosage : Oui/Non",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"- Quantité delivrée par N° de lot : Oui/Non",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"- la date de peremption : Oui/Non",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"- Nom et adresse du client  : Oui/Non",0,1,'L',1,1);

$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,"Les produits pharmaceutiques commercialisées ",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"Médicaments: Oui/Non",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"Consommable: Oui/Non",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"Réactifs: Oui/Non",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"Dentaire: Oui/Non",0,1,'L',1,1);

$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,"Surface de stockage couverte utile superieure à 300m2  : Oui/Non ",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"avec 200m2 au sol d'un seul tenant : Oui/Non",0,1,'L',1,1);

$pdf->SetXY(5,$pdf->GetY()+5);$pdf->Cell(200,5,"Les magazins de stokage ne sont destinées qu'a la detention des produits pharmaceutiques ",0,1,'L',1,1);
$pdf->SetXY(5,$pdf->GetY());$pdf->Cell(200,5,"a usage de la medecine humaine : Oui/Non",0,1,'L',1,1);
