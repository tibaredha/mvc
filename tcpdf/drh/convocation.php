...
$pdf->SetXY(70,80);$pdf->Cell(65,15,'دعــــوة',1,1,'C');
$pdf->SetFont('aefurat', '', 18);

$pdf->Text(25,$pdf->GetY()+5,"السيد  : مدير المؤسسة العمومية الاستشفائية عين وسارة ");

$pdf->SetFont('aefurat', '', 18);
$pdf->Text(5,$pdf->GetY()+15,"إلــى السيد(ة) : ");
$pdf->Text(5,$pdf->GetY()+15,"الرتبة : "." ");
//$pdf->Line(5 ,70 ,203 ,70 );
$pdf->Text(5,$pdf->GetY()+15,"المصلحة :");
$pdf->Text(5,$pdf->GetY()+15,"بصفتكم :");
$pdf->Text(5,$pdf->GetY()+15,"يشرفنا أن ندعوكم لحضور ");
$pdf->Text(5,$pdf->GetY()+15,"يوم :"." _____________________ "."على الساعة : "." _________ ");
$pdf->Text(5,$pdf->GetY()+15,"بـ : ");
$pdf->Text(128,$pdf->GetY()+15,"عين وسارة في :  ");
$pdf->Text(150,$pdf->GetY()+15," المدير");
