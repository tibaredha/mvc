...
{ 
	...
	function titre1($uc,$CNASAT,$ccp,$JOURS,$NOMAR,$PRENOMAR,$DATNSC,$SF,$GRADE,$cat,$ech,$ENFS)
    {
		...
		//$this->SetXY(50,$this->GetY());$this->Cell(60,8,'التعويضات والمنح',1,0,'C',1,1);$this->Cell(40,8,'المبلغ',1,1,'C',1,1);
		
		
		
		
		//$this->Rect(105, $this->GetY(), 100, 110 ,"d");
		//$this->Rect(10, $this->GetY()+50, 90, 60 ,"d");
		//$this->SetXY(115,186);$this->Cell(80,8,'الاقتطاعات',1,1,'C');
