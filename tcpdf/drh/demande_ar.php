...
$pdf->SetXY(6,$pdf->GetY()+8);$pdf->Cell(198,15,'طلـــــب عطلــــــــة',0,1,'C',1,0);
$pdf->SetFont('aefurat', '', 14);
$pdf->Text(5,$pdf->GetY()+8," الاسم :");              $pdf->Text(120,$pdf->GetY()," اللقب :");
$pdf->Text(5,$pdf->GetY()+8,"الرتبـــة:");
$pdf->Text(5,$pdf->GetY()+8,"الوظيفـة:");
$pdf->Text(5,$pdf->GetY()+8,"المصلحة:");             $pdf->Text(120,$pdf->GetY(),"المدة :");
$pdf->Text(5,$pdf->GetY()+8,"تاريخ بداية العطلة:");  $pdf->Text(120,$pdf->GetY(),"تاريخ نهاية العطلة:");
$pdf->Text(4,$pdf->GetY()+8,"سبب الخروج:");          $pdf->Text(120,$pdf->GetY()," المستخلـف:");
$pdf->Text(5,$pdf->GetY()+8,"إمضاء المعني");         $pdf->Text(70,$pdf->GetY(),"إمضاء المستخلف");$pdf->Text(130,$pdf->GetY(),"رئيس المصلحة");
...
$pdf->Text(100,$pdf->GetY()+25," عين وسارة في :  ");
//$pdf->Text(135,250,$date);
...
// $pdf->Text(6,$pdf->GetY()+8,"الرتبـــة :"); $pdf->SetTextColor(225,0,0);$pdf->Text(32,$pdf->GetY(),$pdf->nbrtostring("grh","grade","idg",$result["rnvgradear"],"gradear"));$pdf->SetTextColor(0,0,0);
